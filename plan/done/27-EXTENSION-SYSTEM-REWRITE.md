...
> **STATUS: ERLEDIGT (April 2026)** — verifiziert gegen den Code:
> - `crates/raijin-extension-api/wit/extension.wit` Zeile 1 ist bereits `package raijin:extension;`
> - `crates/raijin-extension-host/src/wasm_host/wit/` enthält nur noch `latest.rs` — keine `since_v*` Verzeichnisse
> - `wasm_host/wit.rs` hat nur noch `pub(crate) mod latest;`
>
> Der ursprüngliche Plan-Text bleibt unten als Historie.
