...
pub use settings::{
    ...
    clamp_font_size, default_theme, observe_buffer_font_size_adjustment, reset_agent_buffer_font_size,
    reset_agent_ui_font_size, reset_buffer_font_size, reset_ui_font_size, set_mode, set_theme,
    setup_ui_font,
};
