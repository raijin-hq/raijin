...
impl GoToLine {
    fn register(editor: &mut Editor, _window: Option<&mut Window>, cx: &mut Context<Editor>) {
        ...
        editor
            .register_action(move |_: &raijin_editor::actions::ToggleGoToLine, window, cx| {
    ...
    fn on_line_editor_event(
        ...
        match event {
            ...
            raijin_editor::EditorEvent::BufferEdited => self.highlight_current_line(cx),
            _ => {}
        }
    }
...
mod tests {
    ...
    use raijin_editor::actions::{MoveRight, MoveToBeginning, SelectAll};
    ...
    fn open_go_to_line_view(
        ...
        cx.dispatch_action(raijin_editor::actions::ToggleGoToLine);
        workspace.update(cx, |workspace, cx| {
