...
use inazuma_settings_content::{PlatformOverrides, ReleaseChannelOverrides};
...
pub(crate) mod m_2025_01_02 {
    ...
    pub(crate) use inazuma_settings_framework::SETTINGS_PATTERNS;
}
...
pub(crate) mod m_2025_01_29 {
    ...
    pub(crate) use inazuma_settings_framework::{SETTINGS_PATTERNS, replace_edit_prediction_provider_setting};
}
...
pub(crate) mod m_2025_10_01 {
    ...
    pub(crate) use inazuma_settings_framework::flatten_code_actions_formatters;
}

pub(crate) mod m_2025_10_02 {
    mod settings;

    pub(crate) use inazuma_settings_framework::remove_formatters_on_save;
}
...
pub(crate) mod m_2025_10_16 {
    ...
    pub(crate) use inazuma_settings_framework::restore_code_actions_on_format;
}

pub(crate) mod m_2025_10_17 {
    mod settings;

    pub(crate) use inazuma_settings_framework::make_file_finder_include_ignored_an_enum;
}

pub(crate) mod m_2025_10_21 {
    mod settings;

    pub(crate) use inazuma_settings_framework::make_relative_line_numbers_an_enum;
}
...
pub(crate) mod m_2025_11_25 {
    ...
    pub(crate) use inazuma_settings_framework::remove_context_server_source;
}
...
pub(crate) mod m_2025_01_27 {
    ...
    pub(crate) use inazuma_settings_framework::make_auto_indent_an_enum;
}

pub(crate) mod m_2026_02_02 {
    mod settings;

    pub(crate) use inazuma_settings_framework::move_edit_prediction_provider_to_edit_predictions;
}

pub(crate) mod m_2026_02_03 {
    mod settings;

    pub(crate) use inazuma_settings_framework::migrate_experimental_sweep_mercury;
}

pub(crate) mod m_2026_02_04 {
    mod settings;

    pub(crate) use inazuma_settings_framework::migrate_tool_permission_defaults;
}

pub(crate) mod m_2026_02_25 {
    mod settings;

    pub(crate) use inazuma_settings_framework::migrate_builtin_agent_servers_to_registry;
}
