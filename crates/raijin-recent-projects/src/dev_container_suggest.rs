...
use raijin_dev_container::find_configs_in_snapshot;
...
use raijin_worktree::UpdatedEntriesSet;
    ...
    cx.on_next_frame(window, move |workspace, _window, cx| {
        ...
        workspace.show_notification(notification_id, cx, |cx| {
            cx.new(move |cx| {
                ...
                .primary_on_click({
                    move |window, cx| {
                        window.dispatch_action(Box::new(raijin_actions::OpenDevContainer), cx);
                    }
                })
