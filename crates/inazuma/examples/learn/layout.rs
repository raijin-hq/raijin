    ...
    div()
        ...
        .child(
            div()
                .flex()
                .gap_2()
                .child(block("fixed", inazuma::red(), text).flex_none().w_16().h_8())
                .child(block("flex_1 (grows)", inazuma::green(), text).flex_1().h_8())
                .child(block("fixed", inazuma::blue(), text).flex_none().w_16().h_8()),
        )
}
