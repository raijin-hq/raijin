...
static RAIJIN_LOG: RaijinLog = RaijinLog {};

pub struct RaijinLog {}

impl log::Log for RaijinLog {
...
mod tests {
    ...
    #[test]
    fn test_crate_name() {
        assert_eq!(crate_name!(), "raijin_log");
        assert_eq!(
