...
impl ProtoConversion for dap_types::ModuleId {
    type ProtoType = raijin_proto::dap_module_id::Id;
    type Output = Self;
...
impl ProtoConversion for dap_types::Module {
    ...
    fn to_proto(self) -> Self::ProtoType {
        DapModule {
            id: Some(raijin_proto::DapModuleId {
    ...
    fn from_proto(payload: Self::ProtoType) -> Result<Self> {
        ...
        {
            raijin_proto::dap_module_id::Id::String(string) => dap_types::ModuleId::String(string),
            raijin_proto::dap_module_id::Id::Number(num) => dap_types::ModuleId::Number(num),
        };
...
impl ProtoConversion for dap_types::SteppingGranularity {
    type ProtoType = raijin_proto::SteppingGranularity;
    type Output = Self;
...
impl ProtoConversion for dap_types::OutputEventCategory {
    type ProtoType = raijin_proto::DapOutputCategory;
    type Output = Self;
...
impl ProtoConversion for dap_types::OutputEvent {
    type ProtoType = raijin_proto::DapOutputEvent;
    type Output = Self;
    ...
    fn from_proto(payload: Self::ProtoType) -> Self {
        Self {
            category: payload
                .category
                .and_then(raijin_proto::DapOutputCategory::from_i32)
            ...
            group: payload
                .group
                .and_then(raijin_proto::DapOutputEventGroup::from_i32)
...
impl ProtoConversion for dap_types::OutputEventGroup {
    type ProtoType = raijin_proto::DapOutputEventGroup;
    type Output = Self;
...
impl ProtoConversion for dap_types::CompletionItem {
    type ProtoType = raijin_proto::DapCompletionItem;
    type Output = Self;
...
impl ProtoConversion for dap_types::CompletionItemType {
    type ProtoType = raijin_proto::DapCompletionItemType;
    type Output = Self;
...
impl ProtoConversion for dap_types::Thread {
    type ProtoType = raijin_proto::DapThread;
    type Output = Self;

    fn to_proto(self) -> Self::ProtoType {
        raijin_proto::DapThread {
            id: self.id,
            name: self.name,
        }
    }
