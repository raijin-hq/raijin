...
fn dap_granularity_from_settings(
    ...
    match granularity {
        inazuma_settings_framework::SteppingGranularity::Instruction => dap_types::SteppingGranularity::Instruction,
        inazuma_settings_framework::SteppingGranularity::Line => dap_types::SteppingGranularity::Line,
        inazuma_settings_framework::SteppingGranularity::Statement => dap_types::SteppingGranularity::Statement,
    }
}
