use raijin_editor::{Bias, Editor, SelectionEffects, scroll::Autoscroll, styled_runs_for_code_label};
...
use raijin_project::{Project, Symbol, lsp_store::SymbolLocation};
    ...
    cx.observe_new(
        |workspace: &mut Workspace, _window, _: &mut Context<Workspace>| {
            workspace.register_action(
                |workspace, _: &raijin_workspace::ToggleProjectSymbols, window, cx| {
...
mod tests {
    ...
    use raijin_language::{FakeLspAdapter, Language, LanguageConfig, LanguageMatcher};
    use raijin_lsp::OneOf;
    ...
    async fn test_project_symbols(cx: &mut TestAppContext) {
        ...
        fake_server.set_request_handler::<raijin_lsp::WorkspaceSymbolRequest, _, _>(
            move |params: raijin_lsp::WorkspaceSymbolParams, cx| {
                ...
                async move {
                    ...
                    Ok(Some(raijin_lsp::WorkspaceSymbolResponse::Flat(
                        matches
                            .into_iter()
        ...
        // https://github.com/raijin-industries/raijin/issues/861
    ...
    fn symbol(name: &str, path: impl AsRef<Path>) -> raijin_lsp::SymbolInformation {
        #[allow(deprecated)]
        raijin_lsp::SymbolInformation {
            ...
            location: raijin_lsp::Location::new(
                raijin_lsp::Uri::from_file_path(path.as_ref()).unwrap(),
                raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(0, 0)),
            ),
        }
    }
}
