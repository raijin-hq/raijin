...
use raijin_language::{Buffer, BufferEvent};
use raijin_multi_buffer::MultiBuffer;
use raijin_ui::prelude::*;
use raijin_workspace::item::Item;
use raijin_workspace::{Pane, Workspace};
...
impl SvgPreviewView {
    ...
    fn subscribe_to_workspace(
        ...
        cx.subscribe_in(
            &workspace,
            window,
            move |this: &mut SvgPreviewView, workspace, event: &raijin_workspace::Event, window, cx| {
    ...
    pub fn register(workspace: &mut Workspace, _window: &mut Window, _cx: &mut Context<Workspace>) {
        ...
        workspace.register_action(move |workspace, _: &OpenPreviewToTheSide, window, cx| {
                ...
                && Self::is_svg_file(&editor, cx)
            {
                ...
                let pane = workspace
                    .find_pane_in_direction(raijin_workspace::SplitDirection::Right, cx)
                    .unwrap_or_else(|| {
...
impl Item for SvgPreviewView {
    ...
    fn to_item_events(_event: &Self::Event, _f: &mut dyn FnMut(raijin_workspace::item::ItemEvent)) {}
}
