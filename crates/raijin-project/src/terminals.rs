...
use raijin_terminal::{
    TaskState, TaskStatus, Terminal, TerminalBuilder, insert_raijin_terminal_env,
...
fn create_remote_shell(
    ...
    insert_raijin_terminal_env(&mut env, &raijin_release_channel::AppVersion::global(cx));
