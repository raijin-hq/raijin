...
pub trait LocalDapCommand: 'static + Send + Sync + std::fmt::Debug {
    ...
    type DapRequest: 'static + Send + raijin_dap::requests::Request;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments;

    fn response_from_dap(
        &self,
        message: <Self::DapRequest as raijin_dap::requests::Request>::Response,
...
impl LocalDapCommand for NextCommand {
    type Response = <Next as raijin_dap::requests::Request>::Response;
    ...
    fn response_from_dap(
        &self,
        _message: <Self::DapRequest as raijin_dap::requests::Request>::Response,
    ) -> Result<Self::Response> {
        Ok(())
    }
}
...
impl LocalDapCommand for StepInCommand {
    type Response = <raijin_dap::requests::StepIn as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::StepIn;
...
impl LocalDapCommand for StepOutCommand {
    type Response = <raijin_dap::requests::StepOut as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::StepOut;
...
impl LocalDapCommand for StepBackCommand {
    type Response = <raijin_dap::requests::StepBack as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::StepBack;
...
impl LocalDapCommand for ContinueCommand {
    type Response = <Continue as raijin_dap::requests::Request>::Response;
...
impl LocalDapCommand for PauseCommand {
    type Response = <raijin_dap::requests::Pause as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::Pause;
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::PauseArguments {
...
impl LocalDapCommand for DisconnectCommand {
    type Response = <raijin_dap::requests::Disconnect as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::Disconnect;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::DisconnectArguments {
...
impl LocalDapCommand for TerminateThreadsCommand {
    type Response = <raijin_dap::requests::TerminateThreads as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::TerminateThreads;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::TerminateThreadsArguments {
...
impl LocalDapCommand for TerminateCommand {
    type Response = <raijin_dap::requests::Terminate as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::Terminate;

    fn is_supported(capabilities: &Capabilities) -> bool {
        capabilities.supports_terminate_request.unwrap_or_default()
    }
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::TerminateArguments {
            restart: self.restart,
        }
    }
...
impl LocalDapCommand for RestartCommand {
    type Response = <raijin_dap::requests::Restart as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::Restart;
...
impl LocalDapCommand for VariablesCommand {
    ...
    type DapRequest = raijin_dap::requests::Variables;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::VariablesArguments {
...
impl LocalDapCommand for SetVariableValueCommand {
    ...
    type DapRequest = raijin_dap::requests::SetVariable;
    fn is_supported(capabilities: &Capabilities) -> bool {
        capabilities.supports_set_variable.unwrap_or_default()
    }
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::SetVariableArguments {
            format: None,
...
impl LocalDapCommand for RestartStackFrameCommand {
    type Response = <raijin_dap::requests::RestartFrame as raijin_dap::requests::Request>::Response;
    type DapRequest = raijin_dap::requests::RestartFrame;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::RestartFrameArguments {
...
impl LocalDapCommand for ModulesCommand {
    type Response = Vec<raijin_dap::Module>;
    type DapRequest = raijin_dap::requests::Modules;
    const CACHEABLE: bool = true;
...
impl DapCommand for ModulesCommand {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(message
            .modules
            .into_iter()
            .filter_map(|module| raijin_dap::Module::from_proto(module).ok())
            .collect())
    }
}
...
impl LocalDapCommand for LoadedSourcesCommand {
    type Response = Vec<raijin_dap::Source>;
    type DapRequest = raijin_dap::requests::LoadedSources;
    const CACHEABLE: bool = true;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::LoadedSourcesArguments {}
    }
...
impl DapCommand for LoadedSourcesCommand {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(message
            .sources
            .into_iter()
            .map(raijin_dap::Source::from_proto)
            .collect())
    }
}
...
impl LocalDapCommand for StackTraceCommand {
    type Response = Vec<raijin_dap::StackFrame>;
    type DapRequest = raijin_dap::requests::StackTrace;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::StackTraceArguments {
            thread_id: self.thread_id,
...
impl DapCommand for StackTraceCommand {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(message
            .frames
            .into_iter()
            .map(raijin_dap::StackFrame::from_proto)
            .collect())
    }
...
impl LocalDapCommand for ScopesCommand {
    type Response = Vec<raijin_dap::Scope>;
    type DapRequest = raijin_dap::requests::Scopes;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::ScopesArguments {
            frame_id: self.stack_frame_id,
        }
    }
...
impl LocalDapCommand for super::session::CompletionsQuery {
    type Response = raijin_dap::CompletionsResponse;
    type DapRequest = raijin_dap::requests::Completions;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::CompletionsArguments {
...
impl DapCommand for super::session::CompletionsQuery {
    ...
    fn response_from_proto(&self, message: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(raijin_dap::CompletionsResponse {
...
pub(crate) struct EvaluateCommand {
    ...
    pub context: Option<raijin_dap::EvaluateArgumentsContext>,
    pub source: Option<raijin_dap::Source>,
}

impl LocalDapCommand for EvaluateCommand {
    type Response = raijin_dap::EvaluateResponse;
    type DapRequest = raijin_dap::requests::Evaluate;
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::EvaluateArguments {
...
impl DapCommand for EvaluateCommand {
    ...
    fn from_proto(request: &Self::ProtoRequest) -> Self {
        Self {
            ...
            frame_id: request.frame_id,
            context: Some(raijin_dap::EvaluateArgumentsContext::from_proto(request.context())),
            source: None,
        }
    }
...
impl LocalDapCommand for ThreadsCommand {
    type Response = Vec<raijin_dap::Thread>;
    type DapRequest = raijin_dap::requests::Threads;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::ThreadsArgument {}
    }
...
fn dap_client_capabilities(adapter_id: String) -> InitializeRequestArguments {
    InitializeRequestArguments {
        client_id: Some("raijin".to_owned()),
        client_name: Some("Raijin".to_owned()),
        adapter_id,
...
impl LocalDapCommand for Initialize {
    ...
    type DapRequest = raijin_dap::requests::Initialize;
...
impl LocalDapCommand for ConfigurationDone {
    type Response = ();
    type DapRequest = raijin_dap::requests::ConfigurationDone;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::ConfigurationDoneArguments {}
    }
...
impl LocalDapCommand for Launch {
    type Response = ();
    type DapRequest = raijin_dap::requests::Launch;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::LaunchRequestArguments {
            raw: self.raw.clone(),
        }
    }
...
impl LocalDapCommand for Attach {
    type Response = ();
    type DapRequest = raijin_dap::requests::Attach;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::AttachRequestArguments {
            raw: self.raw.clone(),
        }
    }
...
pub(super) struct SetBreakpoints {
    pub(super) source: raijin_dap::Source,
    pub(super) breakpoints: Vec<SourceBreakpoint>,
    pub(super) source_modified: Option<bool>,
}

impl LocalDapCommand for SetBreakpoints {
    type Response = Vec<raijin_dap::Breakpoint>;
    type DapRequest = raijin_dap::requests::SetBreakpoints;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::SetBreakpointsArguments {
            lines: None,
...
impl LocalDapCommand for DataBreakpointInfoCommand {
    type Response = raijin_dap::DataBreakpointInfoResponse;
    type DapRequest = raijin_dap::requests::DataBreakpointInfo;
    const CACHEABLE: bool = true;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        ...
        raijin_dap::DataBreakpointInfoArguments {
            variables_reference,
            name,
            frame_id,
            bytes,
...
pub(crate) struct SetDataBreakpointsCommand {
    pub breakpoints: Vec<raijin_dap::DataBreakpoint>,
}

impl LocalDapCommand for SetDataBreakpointsCommand {
    type Response = Vec<raijin_dap::Breakpoint>;
    type DapRequest = raijin_dap::requests::SetDataBreakpoints;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::SetDataBreakpointsArguments {
...
impl LocalDapCommand for SetExceptionBreakpoints {
    type Response = Vec<raijin_dap::Breakpoint>;
    type DapRequest = raijin_dap::requests::SetExceptionBreakpoints;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        match self {
            SetExceptionBreakpoints::Plain { filters } => raijin_dap::SetExceptionBreakpointsArguments {
                filters: filters.clone(),
                exception_options: None,
                filter_options: None,
            },
            SetExceptionBreakpoints::WithOptions { filters } => {
                raijin_dap::SetExceptionBreakpointsArguments {
                    filters: vec![],
...
impl LocalDapCommand for LocationsCommand {
    type Response = raijin_dap::LocationsResponse;
    type DapRequest = raijin_dap::requests::Locations;
    const CACHEABLE: bool = true;

    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::LocationsArguments {
...
impl DapCommand for LocationsCommand {
    ...
    fn response_from_proto(&self, response: Self::ProtoResponse) -> Result<Self::Response> {
        Ok(raijin_dap::LocationsResponse {
            source: response
                .source
                .map(<raijin_dap::Source as ProtoConversion>::from_proto)
...
impl LocalDapCommand for ReadMemory {
    ...
    type DapRequest = raijin_dap::requests::ReadMemory;
    const CACHEABLE: bool = true;
    ...
    fn to_dap(&self) -> <Self::DapRequest as raijin_dap::requests::Request>::Arguments {
        raijin_dap::ReadMemoryArguments {
...
impl LocalDapCommand for raijin_dap::WriteMemoryArguments {
    type Response = raijin_dap::WriteMemoryResponse;
    type DapRequest = raijin_dap::requests::WriteMemory;
    fn is_supported(capabilities: &Capabilities) -> bool {
        capabilities
