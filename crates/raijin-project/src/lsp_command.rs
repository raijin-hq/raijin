...
use raijin_client::proto::{self, PeerId};
...
fn code_action_kind_matches(requested: &raijin_lsp::CodeActionKind, actual: &raijin_lsp::CodeActionKind) -> bool {
...
pub fn lsp_formatting_options(settings: &LanguageSettings) -> raijin_lsp::FormattingOptions {
    raijin_lsp::FormattingOptions {
        ...
        ..raijin_lsp::FormattingOptions::default()
    }
}

pub fn file_path_to_lsp_url(path: &Path) -> Result<raijin_lsp::Uri> {
    match raijin_lsp::Uri::from_file_path(path) {
        Ok(url) => Ok(url),
        Err(()) => anyhow::bail!("Invalid file path provided to LSP request: {path:?}"),
    }
}

pub(crate) fn make_text_document_identifier(path: &Path) -> Result<raijin_lsp::TextDocumentIdentifier> {
    Ok(raijin_lsp::TextDocumentIdentifier {
...
pub(crate) fn make_lsp_text_document_position(
    path: &Path,
    position: PointUtf16,
) -> Result<raijin_lsp::TextDocumentPositionParams> {
    Ok(raijin_lsp::TextDocumentPositionParams {
...
pub trait LspCommand: 'static + Sized + Send + std::fmt::Debug {
    ...
    type LspRequest: 'static + Send + raijin_lsp::request::Request;
    ...
    fn to_lsp_params_or_response(
        ...
        LspParamsOrResponse<<Self::LspRequest as raijin_lsp::request::Request>::Params, Self::Response>,
    > {
    ...
    fn to_lsp(
        ...
        language_server: &Arc<LanguageServer>,
        cx: &App,
    ) -> Result<<Self::LspRequest as raijin_lsp::request::Request>::Params>;

    async fn response_from_lsp(
        self,
        message: <Self::LspRequest as raijin_lsp::request::Request>::Result,
...
pub(crate) struct GetCompletions {
    ...
    pub server_id: Option<raijin_lsp::LanguageServerId>,
}

#[derive(Clone, Debug)]
pub(crate) struct GetCodeActions {
    pub range: Range<Anchor>,
    pub kinds: Option<Vec<raijin_lsp::CodeActionKind>>,
}
...
pub(crate) struct OnTypeFormatting {
    pub position: PointUtf16,
    pub trigger: String,
    pub options: raijin_lsp::FormattingOptions,
    pub push_to_history: bool,
}
...
impl LspCommand for PrepareRename {
    ...
    type LspRequest = raijin_lsp::request::PrepareRenameRequest;
    ...
    fn to_lsp_params_or_response(
        ...
        language_server: &Arc<LanguageServer>,
        cx: &App,
    ) -> Result<LspParamsOrResponse<raijin_lsp::TextDocumentPositionParams, PrepareRenameResponse>> {
        let rename_provider = language_server
            .adapter_server_capabilities()
            .server_capabilities
            .rename_provider;
        match rename_provider {
            Some(raijin_lsp::OneOf::Right(RenameOptions {
            ...
            Some(raijin_lsp::OneOf::Right(_)) => Ok(LspParamsOrResponse::Response(
                PrepareRenameResponse::OnlyUnpreparedRenameSupported,
            )),
            Some(raijin_lsp::OneOf::Left(true)) => Ok(LspParamsOrResponse::Response(
                PrepareRenameResponse::OnlyUnpreparedRenameSupported,
            )),
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::PrepareRenameResponse>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
        ...
        buffer.read_with(&cx, |buffer, _| match message {
            Some(raijin_lsp::PrepareRenameResponse::Range(range))
            | Some(raijin_lsp::PrepareRenameResponse::RangeWithPlaceholder { range, .. }) => {
            ...
            Some(raijin_lsp::PrepareRenameResponse::DefaultBehavior { .. }) => {
    ...
    fn to_proto(&self, project_id: u64, buffer: &Buffer) -> proto::PrepareRename {
        proto::PrepareRename {
            ...
            position: Some(raijin_language::proto::serialize_anchor(
    ...
    fn response_to_proto(
        ...
        match response {
            PrepareRenameResponse::Success(range) => proto::PrepareRenameResponse {
                ...
                start: Some(raijin_language::proto::serialize_anchor(&range.start)),
                end: Some(raijin_language::proto::serialize_anchor(&range.end)),
...
impl LspCommand for PerformRename {
    ...
    type LspRequest = raijin_lsp::request::Rename;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::RenameParams> {
        Ok(raijin_lsp::RenameParams {
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::WorkspaceEdit>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
...
impl LspCommand for GetDefinitions {
    ...
    type LspRequest = raijin_lsp::request::GotoDefinition;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::GotoDefinitionParams> {
        Ok(raijin_lsp::GotoDefinitionParams {
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::GotoDefinitionResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetDeclarations {
    type Response = Vec<LocationLink>;
    type LspRequest = raijin_lsp::request::GotoDeclaration;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|capability| match capability {
                raijin_lsp::DeclarationCapability::Simple(supported) => supported,
                raijin_lsp::DeclarationCapability::RegistrationOptions(..) => true,
                raijin_lsp::DeclarationCapability::Options(..) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::GotoDeclarationParams> {
        Ok(raijin_lsp::GotoDeclarationParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::GotoDeclarationResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetImplementations {
    type Response = Vec<LocationLink>;
    type LspRequest = raijin_lsp::request::GotoImplementation;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|capability| match capability {
                raijin_lsp::ImplementationProviderCapability::Simple(enabled) => enabled,
                raijin_lsp::ImplementationProviderCapability::Options(_options) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::GotoImplementationParams> {
        Ok(raijin_lsp::GotoImplementationParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::GotoImplementationResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetTypeDefinitions {
    type Response = Vec<LocationLink>;
    type LspRequest = raijin_lsp::request::GotoTypeDefinition;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        !matches!(
            ...
            None | Some(raijin_lsp::TypeDefinitionProviderCapability::Simple(false))
        )
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::GotoTypeDefinitionParams> {
        Ok(raijin_lsp::GotoTypeDefinitionParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::GotoTypeDefinitionResponse>,
        project: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
pub async fn location_links_from_lsp(
    ...
    match message {
        raijin_lsp::GotoDefinitionResponse::Scalar(loc) => {
            unresolved_links.push((None, loc.uri, loc.range));
        }

        raijin_lsp::GotoDefinitionResponse::Array(locs) => {
            unresolved_links.extend(locs.into_iter().map(|l| (None, l.uri, l.range)));
        }

        raijin_lsp::GotoDefinitionResponse::Link(links) => {
...
impl LspCommand for GetReferences {
    ...
    type LspRequest = raijin_lsp::request::References;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::ReferenceParams> {
        Ok(raijin_lsp::ReferenceParams {
            text_document_position: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
            context: raijin_lsp::ReferenceContext {
    ...
    async fn response_from_lsp(
        self,
        locations: Option<Vec<raijin_lsp::Location>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
...
impl LspCommand for GetDocumentHighlights {
    ...
    type LspRequest = raijin_lsp::request::DocumentHighlightRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::DocumentHighlightParams> {
        Ok(raijin_lsp::DocumentHighlightParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        lsp_highlights: Option<Vec<raijin_lsp::DocumentHighlight>>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
            ...
            lsp_highlights
                ...
                .map(|lsp_highlight| {
                    ...
                    DocumentHighlight {
                        ...
                        kind: lsp_highlight
                            .kind
                            .unwrap_or(raijin_lsp::DocumentHighlightKind::READ),
                    }
                })
                .collect()
        }))
...
impl LspCommand for GetDocumentSymbols {
    ...
    type LspRequest = raijin_lsp::request::DocumentSymbolRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::DocumentSymbolParams> {
        Ok(raijin_lsp::DocumentSymbolParams {
            text_document: make_text_document_identifier(path)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        lsp_symbols: Option<raijin_lsp::DocumentSymbolResponse>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        let symbols = match lsp_symbols {
            raijin_lsp::DocumentSymbolResponse::Flat(symbol_information) => symbol_information
                .into_iter()
                ...
                .collect(),
            raijin_lsp::DocumentSymbolResponse::Nested(nested_responses) => {
                fn convert_symbol(lsp_symbol: raijin_lsp::DocumentSymbol) -> DocumentSymbol {
                    DocumentSymbol {
                        name: lsp_symbol.name,
                        kind: lsp_symbol.kind,
            ...
            .map(|symbol| {
                fn convert_symbol_to_proto(symbol: DocumentSymbol) -> proto::DocumentSymbol {
                    proto::DocumentSymbol {
                        ...
                        kind: unsafe { mem::transmute::<raijin_lsp::SymbolKind, i32>(symbol.kind) },
    ...
    async fn response_from_proto(
        ...
        for serialized_symbol in message.symbols {
            fn deserialize_symbol_with_children(
                ...
                let kind =
                    unsafe { mem::transmute::<i32, raijin_lsp::SymbolKind>(serialized_symbol.kind) };
...
impl LspCommand for GetSignatureHelp {
    ...
    type LspRequest = raijin_lsp::SignatureHelpRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _cx: &App,
    ) -> Result<raijin_lsp::SignatureHelpParams> {
        Ok(raijin_lsp::SignatureHelpParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            context: None,
            work_done_progress_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::SignatureHelp>,
        lsp_store: Entity<LspStore>,
        _: Entity<Buffer>,
        id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for GetHover {
    ...
    type LspRequest = raijin_lsp::request::HoverRequest;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        match capabilities.server_capabilities.hover_provider {
            Some(raijin_lsp::HoverProviderCapability::Simple(enabled)) => enabled,
            Some(raijin_lsp::HoverProviderCapability::Options(_)) => true,
            None => false,
        }
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::HoverParams> {
        Ok(raijin_lsp::HoverParams {
            text_document_position_params: make_lsp_text_document_position(path, self.position)?,
            work_done_progress_params: Default::default(),
        })
    }
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::Hover>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
        ...
        fn hover_blocks_from_marked_string(marked_string: raijin_lsp::MarkedString) -> Option<HoverBlock> {
            let block = match marked_string {
                raijin_lsp::MarkedString::String(content) => HoverBlock {
                    text: content,
                    kind: HoverBlockKind::Markdown,
                },
                raijin_lsp::MarkedString::LanguageString(raijin_lsp::LanguageString { language, value }) => {
                    HoverBlock {
                        text: value,
        ...
        let contents = match hover.contents {
            raijin_lsp::HoverContents::Scalar(marked_string) => {
                hover_blocks_from_marked_string(marked_string)
                    .into_iter()
                    .collect()
            }
            raijin_lsp::HoverContents::Array(marked_strings) => marked_strings
                .into_iter()
                .filter_map(hover_blocks_from_marked_string)
                .collect(),
            raijin_lsp::HoverContents::Markup(markup_content) => vec![HoverBlock {
                text: markup_content.value,
                kind: if markup_content.kind == raijin_lsp::MarkupKind::Markdown {
    ...
    fn response_to_proto(
        ...
        if let Some(response) = response {
            let (start, end) = if let Some(range) = response.range {
                (
                    Some(raijin_language::proto::serialize_anchor(&range.start)),
                    Some(raijin_language::proto::serialize_anchor(&range.end)),
                )
            } else {
                (None, None)
            };
    ...
    async fn response_from_proto(
        ...
        let range = if let (Some(start), Some(end)) = (message.start, message.end) {
            raijin_language::proto::deserialize_anchor(start)
                .and_then(|start| raijin_language::proto::deserialize_anchor(end).map(|end| start..end))
        } else {
            None
        };
...
impl GetCompletions {
    pub fn can_resolve_completions(capabilities: &raijin_lsp::ServerCapabilities) -> bool {
        capabilities
            .completion_provider
            .as_ref()
...
impl LspCommand for GetCompletions {
    ...
    type LspRequest = raijin_lsp::request::Completion;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::CompletionParams> {
        Ok(raijin_lsp::CompletionParams {
            text_document_position: make_lsp_text_document_position(path, self.position)?,
    ...
    async fn response_from_lsp(
        self,
        completions: Option<raijin_lsp::CompletionResponse>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
        ...
        let (mut completions, mut is_incomplete) = if let Some(completions) = completions {
            match completions {
                raijin_lsp::CompletionResponse::Array(completions) => (completions, false),
                raijin_lsp::CompletionResponse::List(mut list) => {
                ...
                let lsp_edit = lsp_completion.text_edit.clone().or_else(|| {
                    ...
                    match default_text_edit {
                        CompletionListItemDefaultsEditRange::Range(range) => {
                            Some(raijin_lsp::CompletionTextEdit::Edit(raijin_lsp::TextEdit {
                                range: *range,
                                new_text,
                            }))
                        }
                        CompletionListItemDefaultsEditRange::InsertAndReplace {
                            insert,
                            replace,
                        } => Some(raijin_lsp::CompletionTextEdit::InsertAndReplace(
                            raijin_lsp::InsertReplaceEdit {
                                new_text,
                                insert: *insert,
                                replace: *replace,
                            },
    ...
    fn to_proto(&self, project_id: u64, buffer: &Buffer) -> proto::GetCompletions {
        ...
        proto::GetCompletions {
            project_id,
            buffer_id: buffer.remote_id().into(),
            position: Some(raijin_language::proto::serialize_anchor(&anchor)),
            version: serialize_version(&buffer.version()),
    ...
    async fn from_proto(
        ...
        let position = message
            .position
            .and_then(raijin_language::proto::deserialize_anchor)
            .map(|p| {
        ...
        Ok(Self {
            ...
            server_id: message
                .server_id
                .map(|id| raijin_lsp::LanguageServerId::from_proto(id)),
        })
    }
...
pub(crate) fn parse_completion_text_edit(
    edit: &raijin_lsp::CompletionTextEdit,
    snapshot: &BufferSnapshot,
) -> Option<ParsedCompletionEdit> {
    let (replace_range, insert_range, new_text) = match edit {
        raijin_lsp::CompletionTextEdit::Edit(edit) => (edit.range, None, &edit.new_text),
        raijin_lsp::CompletionTextEdit::InsertAndReplace(edit) => {
...
impl LspCommand for GetCodeActions {
    ...
    type LspRequest = raijin_lsp::request::CodeActionRequest;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        match &capabilities.server_capabilities.code_action_provider {
            None => false,
            Some(raijin_lsp::CodeActionProviderCapability::Simple(false)) => false,
            _ => {
    ...
    fn to_lsp(
        ...
        language_server: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::CodeActionParams> {
        let mut relevant_diagnostics = Vec::new();
        for entry in buffer
            .snapshot()
            .diagnostics_in_range::<_, raijin_language::PointUtf16>(self.range.clone(), false)
        {
        ...
        Ok(raijin_lsp::CodeActionParams {
            text_document: make_text_document_identifier(path)?,
            range: range_to_lsp(self.range.to_point_utf16(buffer))?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
            context: raijin_lsp::CodeActionContext {
                diagnostics: relevant_diagnostics,
                only,
                ..raijin_lsp::CodeActionContext::default()
            },
        })
    }
    ...
    async fn response_from_lsp(
        self,
        actions: Option<raijin_lsp::CodeActionResponse>,
        lsp_store: Entity<LspStore>,
        _: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
        ...
        Ok(actions
            ...
            .filter_map(|entry| {
                let (lsp_action, resolved) = match entry {
                    raijin_lsp::CodeActionOrCommand::CodeAction(lsp_action) => {
                    ...
                    raijin_lsp::CodeActionOrCommand::Command(command) => {
    ...
    fn to_proto(&self, project_id: u64, buffer: &Buffer) -> proto::GetCodeActions {
        proto::GetCodeActions {
            project_id,
            buffer_id: buffer.remote_id().into(),
            start: Some(raijin_language::proto::serialize_anchor(&self.range.start)),
            end: Some(raijin_language::proto::serialize_anchor(&self.range.end)),
            version: serialize_version(&buffer.version()),
        }
    }
...
impl GetCodeActions {
    fn supported_code_action_kinds(
        ...
        match capabilities.server_capabilities.code_action_provider {
            Some(raijin_lsp::CodeActionProviderCapability::Options(CodeActionOptions {
    ...
    pub fn can_resolve_actions(capabilities: &ServerCapabilities) -> bool {
        capabilities
            ...
            .and_then(|options| match options {
                raijin_lsp::CodeActionProviderCapability::Simple(_is_supported) => None,
                raijin_lsp::CodeActionProviderCapability::Options(options) => options.resolve_provider,
            })
            .unwrap_or(false)
    }
}
...
impl LspCommand for OnTypeFormatting {
    ...
    type LspRequest = raijin_lsp::request::OnTypeFormatting;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::DocumentOnTypeFormattingParams> {
        Ok(raijin_lsp::DocumentOnTypeFormattingParams {
            text_document_position: make_lsp_text_document_position(path, self.position)?,
    ...
    async fn response_from_lsp(
        self,
        message: Option<Vec<raijin_lsp::TextEdit>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
    ...
    fn response_to_proto(
        ...
        proto::OnTypeFormattingResponse {
            transaction: response
                .map(|transaction| raijin_language::proto::serialize_transaction(&transaction)),
        }
    }
    ...
    async fn response_from_proto(
        ...
        Ok(Some(raijin_language::proto::deserialize_transaction(transaction)?))
    }
...
impl InlayHints {
    pub async fn lsp_to_project_hint(
        ...
        let kind = lsp_hint.kind.and_then(|kind| match kind {
            raijin_lsp::InlayHintKind::TYPE => Some(InlayHintKind::Type),
            raijin_lsp::InlayHintKind::PARAMETER => Some(InlayHintKind::Parameter),
            _ => None,
        });
        ...
        Ok(InlayHint {
            ...
            tooltip: lsp_hint.tooltip.map(|tooltip| match tooltip {
                raijin_lsp::InlayHintTooltip::String(s) => InlayHintTooltip::String(s),
                raijin_lsp::InlayHintTooltip::MarkupContent(markup_content) => {
                    InlayHintTooltip::MarkupContent(MarkupContent {
                        kind: match markup_content.kind {
                            raijin_lsp::MarkupKind::PlainText => HoverBlockKind::PlainText,
                            raijin_lsp::MarkupKind::Markdown => HoverBlockKind::Markdown,
                        },
    ...
    async fn lsp_inlay_label_to_project(
        lsp_label: raijin_lsp::InlayHintLabel,
        server_id: LanguageServerId,
    ) -> anyhow::Result<InlayHintLabel> {
        let label = match lsp_label {
            raijin_lsp::InlayHintLabel::String(s) => InlayHintLabel::String(s),
            raijin_lsp::InlayHintLabel::LabelParts(lsp_parts) => {
                ...
                for lsp_part in lsp_parts {
                    parts.push(InlayHintLabelPart {
                        ...
                        tooltip: lsp_part.tooltip.map(|tooltip| match tooltip {
                            raijin_lsp::InlayHintLabelPartTooltip::String(s) => {
                                InlayHintLabelPartTooltip::String(s)
                            }
                            raijin_lsp::InlayHintLabelPartTooltip::MarkupContent(markup_content) => {
    ...
    pub fn project_to_proto_hint(response_hint: InlayHint) -> proto::InlayHint {
        ...
        proto::InlayHint {
            position: Some(raijin_language::proto::serialize_anchor(&response_hint.position)),
        ...
        let resolve_state_data = resolve_state
            ...
            .map(|lsp_resolve_state| {
                let value = lsp_resolve_state.value.as_deref().map(|value| {
                    serde_json::from_str::<Option<raijin_lsp::LSPAny>>(value)
                            ...
                            location: {
                                    ...
                                    .zip(part.language_server_id)
                                {
                                    Some(((uri, range), server_id)) => Some((
                                        ...
                                        raijin_lsp::Location {
                                            uri: raijin_lsp::Uri::from_str(&uri).with_context(|| {
    ...
    pub fn project_to_lsp_hint(hint: InlayHint, snapshot: &BufferSnapshot) -> raijin_lsp::InlayHint {
        raijin_lsp::InlayHint {
            position: point_to_lsp(hint.position.to_point_utf16(snapshot)),
            kind: hint.kind.map(|kind| match kind {
                InlayHintKind::Type => raijin_lsp::InlayHintKind::TYPE,
                InlayHintKind::Parameter => raijin_lsp::InlayHintKind::PARAMETER,
            }),
            text_edits: None,
            tooltip: hint.tooltip.and_then(|tooltip| {
                Some(match tooltip {
                    InlayHintTooltip::String(s) => raijin_lsp::InlayHintTooltip::String(s),
                    InlayHintTooltip::MarkupContent(markup_content) => {
                        raijin_lsp::InlayHintTooltip::MarkupContent(raijin_lsp::MarkupContent {
                            kind: match markup_content.kind {
                                HoverBlockKind::PlainText => raijin_lsp::MarkupKind::PlainText,
                                HoverBlockKind::Markdown => raijin_lsp::MarkupKind::Markdown,
            ...
            label: match hint.label {
                InlayHintLabel::String(s) => raijin_lsp::InlayHintLabel::String(s),
                InlayHintLabel::LabelParts(label_parts) => raijin_lsp::InlayHintLabel::LabelParts(
                    label_parts
                        .into_iter()
                        .map(|part| raijin_lsp::InlayHintLabelPart {
                            value: part.value,
                            tooltip: part.tooltip.and_then(|tooltip| {
                                Some(match tooltip {
                                    ...
                                    InlayHintLabelPartTooltip::MarkupContent(markup_content) => {
                                        raijin_lsp::InlayHintLabelPartTooltip::MarkupContent(
                                            raijin_lsp::MarkupContent {
                                                kind: match markup_content.kind {
                                                    ...
                                                    HoverBlockKind::Markdown => {
                                                        raijin_lsp::MarkupKind::Markdown
                                                    }
                                                    HoverBlockKind::Code { .. } => return None,
                                                },
                                                value: markup_content.value,
        ...
        capabilities
            ...
            .and_then(|options| match options {
                ...
                OneOf::Right(capabilities) => match capabilities {
                    raijin_lsp::InlayHintServerCapabilities::Options(o) => o.resolve_provider,
                    raijin_lsp::InlayHintServerCapabilities::RegistrationOptions(o) => {
    ...
    pub fn check_capabilities(capabilities: &ServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|inlay_hint_provider| match inlay_hint_provider {
                raijin_lsp::OneOf::Left(enabled) => *enabled,
                raijin_lsp::OneOf::Right(_) => true,
            })
    }
}
...
impl LspCommand for InlayHints {
    ...
    type LspRequest = raijin_lsp::InlayHintRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::InlayHintParams> {
        Ok(raijin_lsp::InlayHintParams {
            text_document: raijin_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
            range: range_to_lsp(self.range.to_point_utf16(buffer))?,
            work_done_progress_params: Default::default(),
    ...
    async fn response_from_lsp(
        self,
        message: Option<Vec<raijin_lsp::InlayHint>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        mut cx: AsyncApp,
...
impl LspCommand for SemanticTokensFull {
    ...
    type LspRequest = raijin_lsp::SemanticTokensFullRequest;
        ...
        capabilities
            ...
            .is_some_and(|semantic_tokens_provider| {
                let options = match semantic_tokens_provider {
                    raijin_lsp::SemanticTokensServerCapabilities::SemanticTokensOptions(opts) => opts,
                    raijin_lsp::SemanticTokensServerCapabilities::SemanticTokensRegistrationOptions(
                        opts,
                    ) => &opts.semantic_tokens_options,
                };

                match options.full {
                    Some(raijin_lsp::SemanticTokensFullOptions::Bool(is_supported)) => is_supported,
                    Some(raijin_lsp::SemanticTokensFullOptions::Delta { .. }) => true,
                    None => false,
                }
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::SemanticTokensParams> {
        Ok(raijin_lsp::SemanticTokensParams {
            text_document: raijin_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
            partial_result_params: Default::default(),
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::SemanticTokensResult>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        match message {
            Some(raijin_lsp::SemanticTokensResult::Tokens(tokens)) => Ok(SemanticTokensResponse::Full {
                data: tokens.data,
                result_id: tokens.result_id.map(SharedString::new),
            }),
            Some(raijin_lsp::SemanticTokensResult::Partial(_)) => {
                anyhow::bail!(
...
impl LspCommand for SemanticTokensDelta {
    type Response = SemanticTokensResponse;
    type LspRequest = raijin_lsp::SemanticTokensFullDeltaRequest;
    type ProtoRequest = proto::SemanticTokens;
    ...
    fn check_capabilities(&self, capabilities: AdapterServerCapabilities) -> bool {
        capabilities
            ...
            .is_some_and(|semantic_tokens_provider| {
                ...
                match options.full {
                    Some(raijin_lsp::SemanticTokensFullOptions::Delta { delta }) => delta.unwrap_or(false),
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::SemanticTokensDeltaParams> {
        Ok(raijin_lsp::SemanticTokensDeltaParams {
            text_document: raijin_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::SemanticTokensFullDeltaResult>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        match message {
            Some(raijin_lsp::SemanticTokensFullDeltaResult::Tokens(tokens)) => {
                Ok(SemanticTokensResponse::Full {
                    data: tokens.data,
                    result_id: tokens.result_id.map(SharedString::new),
                })
            }
            Some(raijin_lsp::SemanticTokensFullDeltaResult::TokensDelta(delta)) => {
            ...
            Some(raijin_lsp::SemanticTokensFullDeltaResult::PartialTokensDelta { .. }) => {
                anyhow::bail!(
                    "Unexpected semantic tokens response with partial result for inlay hints"
                )
            }
...
impl LspCommand for GetCodeLens {
    type Response = Vec<CodeAction>;
    type LspRequest = raijin_lsp::CodeLensRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::CodeLensParams> {
        Ok(raijin_lsp::CodeLensParams {
            text_document: raijin_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
            work_done_progress_params: raijin_lsp::WorkDoneProgressParams::default(),
            partial_result_params: raijin_lsp::PartialResultParams::default(),
        })
    }

    async fn response_from_lsp(
        self,
        message: Option<Vec<raijin_lsp::CodeLens>>,
        lsp_store: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
...
impl LspCommand for LinkedEditingRange {
    ...
    type LspRequest = raijin_lsp::request::LinkedEditingRange;
    ...
    fn to_lsp(
        ...
        _: &App,
    ) -> Result<raijin_lsp::LinkedEditingRangeParams> {
        let position = self.position.to_point_utf16(&buffer.snapshot());
        Ok(raijin_lsp::LinkedEditingRangeParams {
    ...
    async fn response_from_lsp(
        self,
        message: Option<raijin_lsp::LinkedEditingRanges>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _server_id: LanguageServerId,
        cx: AsyncApp,
    ) -> Result<Vec<Range<Anchor>>> {
        if let Some(raijin_lsp::LinkedEditingRanges { mut ranges, .. }) = message {
...
impl GetDocumentDiagnostics {
        ...
        response
            ...
            .filter_map(|diagnostics| {
                Some(LspPullDiagnostics::Response {
                    ...
                    uri: raijin_lsp::Uri::from_str(diagnostics.uri.as_str()).log_err()?,
    ...
    pub fn deserialize_lsp_diagnostic(diagnostic: proto::LspDiagnostic) -> Result<raijin_lsp::Diagnostic> {
        ...
        let code = diagnostic.code.map(raijin_lsp::NumberOrString::String);
        ...
        let tags = diagnostic
            ...
            .filter_map(|tag| match proto::LspDiagnosticTag::from_i32(tag) {
                Some(proto::LspDiagnosticTag::Unnecessary) => Some(raijin_lsp::DiagnosticTag::UNNECESSARY),
                Some(proto::LspDiagnosticTag::Deprecated) => Some(raijin_lsp::DiagnosticTag::DEPRECATED),
                _ => None,
            })
            .collect::<Vec<_>>();

        Ok(raijin_lsp::Diagnostic {
            range: raijin_language::range_to_lsp(range)?,
            severity: match proto::lsp_diagnostic::Severity::from_i32(diagnostic.severity).unwrap()
            {
                proto::lsp_diagnostic::Severity::Error => Some(raijin_lsp::DiagnosticSeverity::ERROR),
                proto::lsp_diagnostic::Severity::Warning => Some(raijin_lsp::DiagnosticSeverity::WARNING),
                proto::lsp_diagnostic::Severity::Information => {
                    Some(raijin_lsp::DiagnosticSeverity::INFORMATION)
                }
                proto::lsp_diagnostic::Severity::Hint => Some(raijin_lsp::DiagnosticSeverity::HINT),
                _ => None,
            },
            code,
            code_description: diagnostic
                ...
                .map(|code_description| CodeDescription {
                    href: Some(raijin_lsp::Uri::from_str(&code_description).unwrap()),
                }),
    ...
    pub fn serialize_lsp_diagnostic(diagnostic: raijin_lsp::Diagnostic) -> Result<proto::LspDiagnostic> {
        let range = raijin_language::range_from_lsp(diagnostic.range);
        let related_information = diagnostic
            .related_information
            .unwrap_or_default()
            .into_iter()
        ...
        let tags = diagnostic
            ...
            .into_iter()
            .map(|tag| match tag {
                raijin_lsp::DiagnosticTag::UNNECESSARY => proto::LspDiagnosticTag::Unnecessary,
                raijin_lsp::DiagnosticTag::DEPRECATED => proto::LspDiagnosticTag::Deprecated,
        ...
        Ok(proto::LspDiagnostic {
            ...
            severity: match diagnostic.severity {
                Some(raijin_lsp::DiagnosticSeverity::ERROR) => proto::lsp_diagnostic::Severity::Error,
                Some(raijin_lsp::DiagnosticSeverity::WARNING) => proto::lsp_diagnostic::Severity::Warning,
                Some(raijin_lsp::DiagnosticSeverity::INFORMATION) => {
                    proto::lsp_diagnostic::Severity::Information
                }
                Some(raijin_lsp::DiagnosticSeverity::HINT) => proto::lsp_diagnostic::Severity::Hint,
                _ => proto::lsp_diagnostic::Severity::None,
            } as i32,
            code: diagnostic.code.as_ref().map(|code| match code {
                raijin_lsp::NumberOrString::Number(code) => code.to_string(),
                raijin_lsp::NumberOrString::String(code) => code.clone(),
            }),
            source: diagnostic.source.clone(),
            related_information,
            tags,
    ...
    pub fn deserialize_workspace_diagnostics_report(
        report: raijin_lsp::WorkspaceDiagnosticReportResult,
        server_id: LanguageServerId,
        registration_id: Option<SharedString>,
    ) -> Vec<WorkspaceLspPullDiagnostics> {
        let mut pulled_diagnostics = HashMap::default();
        match report {
            raijin_lsp::WorkspaceDiagnosticReportResult::Report(workspace_diagnostic_report) => {
                for report in workspace_diagnostic_report.items {
                    match report {
                        raijin_lsp::WorkspaceDocumentDiagnosticReport::Full(report) => {
                        ...
                        raijin_lsp::WorkspaceDocumentDiagnosticReport::Unchanged(report) => {
            ...
            raijin_lsp::WorkspaceDiagnosticReportResult::Partial(
...
fn process_full_workspace_diagnostics_report(
    diagnostics: &mut HashMap<raijin_lsp::Uri, WorkspaceLspPullDiagnostics>,
    server_id: LanguageServerId,
    report: raijin_lsp::WorkspaceFullDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
...
fn process_unchanged_workspace_diagnostics_report(
    diagnostics: &mut HashMap<raijin_lsp::Uri, WorkspaceLspPullDiagnostics>,
    server_id: LanguageServerId,
    report: raijin_lsp::WorkspaceUnchangedDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
    let mut new_diagnostics = HashMap::default();
...
impl LspCommand for GetDocumentDiagnostics {
    ...
    type LspRequest = raijin_lsp::request::DocumentDiagnosticRequest;
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::DocumentDiagnosticParams> {
        Ok(raijin_lsp::DocumentDiagnosticParams {
            text_document: raijin_lsp::TextDocumentIdentifier {
                uri: file_path_to_lsp_url(path)?,
            },
    ...
    async fn response_from_lsp(
        self,
        message: raijin_lsp::DocumentDiagnosticReportResult,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        server_id: LanguageServerId,
        cx: AsyncApp,
        ...
        let mut pulled_diagnostics = HashMap::default();
        match message {
            raijin_lsp::DocumentDiagnosticReportResult::Report(report) => match report {
                raijin_lsp::DocumentDiagnosticReport::Full(report) => {
                ...
                raijin_lsp::DocumentDiagnosticReport::Unchanged(report) => {
                    if let Some(related_documents) = report.related_documents {
                        process_related_documents(
                            &mut pulled_diagnostics,
                            server_id,
            ...
            raijin_lsp::DocumentDiagnosticReportResult::Partial(report) => {
                if let Some(related_documents) = report.related_documents {
                    process_related_documents(
                        &mut pulled_diagnostics,
                        server_id,
...
impl LspCommand for GetDocumentColor {
    ...
    type LspRequest = raijin_lsp::request::DocumentColor;
    ...
    fn check_capabilities(&self, server_capabilities: AdapterServerCapabilities) -> bool {
        server_capabilities
            ...
            .as_ref()
            .is_some_and(|capability| match capability {
                raijin_lsp::ColorProviderCapability::Simple(supported) => *supported,
                raijin_lsp::ColorProviderCapability::ColorProvider(..) => true,
                raijin_lsp::ColorProviderCapability::Options(..) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::DocumentColorParams> {
        Ok(raijin_lsp::DocumentColorParams {
            text_document: make_text_document_identifier(path)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Vec<raijin_lsp::ColorInformation>,
        _: Entity<LspStore>,
        _: Entity<Buffer>,
        _: LanguageServerId,
        _: AsyncApp,
        ...
        Ok(message
            ...
            .filter_map(|color| {
                ...
                Some(DocumentColor {
                    resolved: false,
                    color_presentations: Vec::new(),
                    lsp_range: raijin_lsp::Range {
                        start: point_to_lsp(start),
                        end: point_to_lsp(end),
                    },
                    color: raijin_lsp::Color {
                        red: color.red,
                        green: color.green,
                        blue: color.blue,
                        alpha: color.alpha,
...
impl LspCommand for GetFoldingRanges {
    ...
    type LspRequest = raijin_lsp::request::FoldingRangeRequest;
    ...
    fn check_capabilities(&self, server_capabilities: AdapterServerCapabilities) -> bool {
        server_capabilities
            ...
            .as_ref()
            .is_some_and(|capability| match capability {
                raijin_lsp::FoldingRangeProviderCapability::Simple(supported) => *supported,
                raijin_lsp::FoldingRangeProviderCapability::FoldingProvider(..)
                | raijin_lsp::FoldingRangeProviderCapability::Options(..) => true,
            })
    }
    ...
    fn to_lsp(
        ...
        _: &Arc<LanguageServer>,
        _: &App,
    ) -> Result<raijin_lsp::FoldingRangeParams> {
        Ok(raijin_lsp::FoldingRangeParams {
            text_document: make_text_document_identifier(path)?,
            work_done_progress_params: Default::default(),
            partial_result_params: Default::default(),
        })
    ...
    async fn response_from_lsp(
        self,
        message: Option<Vec<raijin_lsp::FoldingRange>>,
        _: Entity<LspStore>,
        buffer: Entity<Buffer>,
        _: LanguageServerId,
        cx: AsyncApp,
...
fn process_related_documents(
    diagnostics: &mut HashMap<raijin_lsp::Uri, LspPullDiagnostics>,
    server_id: LanguageServerId,
    documents: impl IntoIterator<Item = (raijin_lsp::Uri, raijin_lsp::DocumentDiagnosticReportKind)>,
    registration_id: Option<SharedString>,
) {
    for (url, report_kind) in documents {
        match report_kind {
            raijin_lsp::DocumentDiagnosticReportKind::Full(report) => process_full_diagnostics_report(
                diagnostics,
                server_id,
                url,
                report,
            ...
            raijin_lsp::DocumentDiagnosticReportKind::Unchanged(report) => {
                process_unchanged_diagnostics_report(
                    diagnostics,
                    server_id,
                    url,
...
fn process_unchanged_diagnostics_report(
    ...
    server_id: LanguageServerId,
    uri: raijin_lsp::Uri,
    report: raijin_lsp::UnchangedDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
...
fn process_full_diagnostics_report(
    ...
    server_id: LanguageServerId,
    uri: raijin_lsp::Uri,
    report: raijin_lsp::FullDocumentDiagnosticReport,
    registration_id: Option<SharedString>,
) {
