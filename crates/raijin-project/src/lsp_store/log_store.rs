...
use inazuma::{App, AppContext as _, Context, Entity, EventEmitter, Global, Subscription, WeakEntity};
use raijin_lsp::{
...
struct ProjectState {
    ...
    copilot_log_subscription: Option<raijin_lsp::Subscription>,
}
...
pub struct LanguageServerState {
    ...
    io_logs_subscription: Option<raijin_lsp::Subscription>,
...
impl LogStore {
    ...
    ) -> Option<&mut Option<raijin_lsp::Subscription>> {
        self.projects
            .get_mut(project)
