...
pub enum InvalidationStrategy {
    ...
    /// in addition to LSP capabilities, Raijin allows omitting certain hint kinds (defined by the corresponding LSP part: type/parameter/other) and toggling hints.
    ...
    pub(super) fn resolve_inlay_hint(
        ...
        if let Some((upstream_client, project_id)) = self.upstream_client() {
            ...
            cx.spawn(async move |_, cx| {
                let resolve_task = lang_server.request::<raijin_lsp::request::InlayHintResolveRequest>(
