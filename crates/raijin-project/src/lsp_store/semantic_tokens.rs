...
use raijin_language::{Buffer, LanguageName, language_settings::all_language_settings};
use raijin_lsp::{AdapterServerCapabilities, LanguageServerId};
use raijin_rpc::{TypedEnvelope, proto};
...
impl SemanticTokenConfig {
    ...
    pub(super) fn update_global_mode(&mut self, new_mode: inazuma_settings_framework::SemanticTokens) -> bool {
            ...
            .entry((server_id, language.cloned()))
        {
            ...
            hash_map::Entry::Vacant(v) => {
                ...
                let legend = match tokens_provider {
                    raijin_lsp::SemanticTokensServerCapabilities::SemanticTokensOptions(opts) => {
                        &opts.legend
                    }
...
pub(super) struct RawSemanticTokens {
    pub servers: HashMap<raijin_lsp::LanguageServerId, Arc<ServerSemanticTokens>>,
}
...
mod tests {
    ...
    use raijin_lsp::SEMANTIC_TOKEN_MODIFIERS;
