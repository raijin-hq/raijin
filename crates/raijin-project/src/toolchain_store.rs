...
#[async_trait(?Send)]
impl raijin_language::LocalLanguageToolchainStore for LocalStore {
    fn active_toolchain(
        self: Arc<Self>,
...
#[async_trait(?Send)]
impl raijin_language::LanguageToolchainStore for RemoteStore {
...
impl raijin_language::LocalLanguageToolchainStore for EmptyToolchainStore {
    fn active_toolchain(
        self: Arc<Self>,
        _: WorktreeId,
        _: &Arc<RelPath>,
