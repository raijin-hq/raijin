...
use encoding_rs;
use raijin_fs::{FakeFs, PathEventKind};
...
use raijin_paths::{config_dir, global_gitignore_path, tasks_file};
...
use raijin_task::{ResolvedTask, ShellKind, TaskContext};
...
use raijin_worktree::WorktreeModelHandle as _;
...
async fn test_default_session_work_dirs_falls_back_to_home_for_empty_project(
    ...
    assert_eq!(ordered_paths, vec![raijin_paths::home_dir().to_path_buf()]);
}
...
#[inazuma::test]
async fn test_external_editorconfig_root_in_parent_stops_traversal(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
...
#[inazuma::test]
async fn test_external_editorconfig_modification_triggers_refresh(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
            ...
            get_all_tasks(
                ...
                Arc::new(TaskContexts {
                    ...
                    active_worktree_context: Some((worktree_id, {
                        ...
                        worktree_context
                            .task_variables
                            .insert(raijin_task::VariableName::WorktreeRoot, "/dir".to_string());
                        worktree_context
                    })),
                    other_worktree_contexts: Vec::new(),
                    lsp_task_sources: HashMap::default(),
...
async fn test_managing_language_servers(cx: &mut inazuma::TestAppContext) {
    ...
    let mut fake_rust_servers = language_registry.register_fake_lsp(
        ...
        FakeLspAdapter {
            ...
            capabilities: raijin_lsp::ServerCapabilities {
                ...
                text_document_sync: Some(raijin_lsp::TextDocumentSyncCapability::Options(
                    raijin_lsp::TextDocumentSyncOptions {
                        save: Some(raijin_lsp::TextDocumentSyncSaveOptions::Supported(true)),
                        ..Default::default()
                    },
                )),
                ..Default::default()
    ...
    assert_eq!(
        fake_rust_server
            ...
            .await
            .text_document,
        raijin_lsp::TextDocumentItem {
            uri: raijin_lsp::Uri::from_file_path(path!("/dir/test.rs")).unwrap(),
            version: 0,
    ...
    assert_eq!(
        fake_rust_server
            .receive_notification::<raijin_lsp::notification::DidChangeTextDocument>()
            .await
            .text_document,
        raijin_lsp::VersionedTextDocumentIdentifier::new(
            raijin_lsp::Uri::from_file_path(path!("/dir/test.rs")).unwrap(),
            1
        )
    );
    ...
    assert_eq!(
        fake_json_server
            ...
            .text_document,
        raijin_lsp::TextDocumentItem {
            uri: raijin_lsp::Uri::from_file_path(path!("/dir/package.json")).unwrap(),
            version: 0,
            text: "{\"a\": 1}".to_string(),
    ...
    assert_eq!(
        fake_rust_server
            ...
            .text_document,
        raijin_lsp::VersionedTextDocumentIdentifier::new(
            raijin_lsp::Uri::from_file_path(path!("/dir/test2.rs")).unwrap(),
            1
        )
    );
    ...
    assert_eq!(
        fake_rust_server
            .receive_notification::<raijin_lsp::notification::DidSaveTextDocument>()
            .await
            .text_document,
        raijin_lsp::TextDocumentIdentifier::new(
            raijin_lsp::Uri::from_file_path(path!("/dir/Cargo.toml")).unwrap()
        )
    );
    assert_eq!(
        fake_json_server
    ...
    assert_eq!(
        fake_rust_server
            .receive_notification::<raijin_lsp::notification::DidCloseTextDocument>()
            .await
            .text_document,
        raijin_lsp::TextDocumentIdentifier::new(raijin_lsp::Uri::from_file_path(path!("/dir/test2.rs")).unwrap()),
    );
    assert_eq!(
        fake_rust_server
            .receive_notification::<raijin_lsp::notification::DidOpenTextDocument>()
            ...
            .text_document,
        raijin_lsp::TextDocumentItem {
            uri: raijin_lsp::Uri::from_file_path(path!("/dir/test3.rs")).unwrap(),
            version: 0,
    ...
    assert_eq!(
        fake_rust_server
            ...
            .await
            .text_document,
        raijin_lsp::TextDocumentIdentifier::new(raijin_lsp::Uri::from_file_path(path!("/dir/test3.rs")).unwrap()),
    );
    assert_eq!(
        fake_json_server
            .receive_notification::<raijin_lsp::notification::DidOpenTextDocument>()
            ...
            .text_document,
        raijin_lsp::TextDocumentItem {
            uri: raijin_lsp::Uri::from_file_path(path!("/dir/test3.json")).unwrap(),
            version: 0,
            text: rust_buffer2.update(cx, |buffer, _| buffer.text()),
            language_id: "json".to_string(),
        },
    ...
    assert_eq!(
        fake_json_server
            ...
            .text_document,
        raijin_lsp::VersionedTextDocumentIdentifier::new(
            raijin_lsp::Uri::from_file_path(path!("/dir/test3.json")).unwrap(),
            1
        )
    );
    ...
    let mut rust_shutdown_requests = fake_rust_server
        .set_request_handler::<raijin_lsp::request::Shutdown, _, _>(|_, _| future::ready(Ok(())));
    ...
    let close_message = raijin_lsp::DidCloseTextDocumentParams {
        text_document: raijin_lsp::TextDocumentIdentifier::new(
            raijin_lsp::Uri::from_file_path(path!("/dir/package.json")).unwrap(),
        ),
    };
    assert_eq!(
        fake_json_server
...
async fn test_language_server_tilde_path(cx: &mut inazuma::TestAppContext) {
    ...
    let expected_path = raijin_paths::home_dir().join(".local/bin/rust-analyzer");
    assert_eq!(
...
async fn test_rescan_fs_change_is_reported_to_language_servers_as_changed(
    ...
    fake_server
        .request::<raijin_lsp::request::RegisterCapability>(
            raijin_lsp::RegistrationParams {
                registrations: vec![raijin_lsp::Registration {
                    id: Default::default(),
                    method: "workspace/didChangeWatchedFiles".to_string(),
                    register_options: serde_json::to_value(
                        raijin_lsp::DidChangeWatchedFilesRegistrationOptions {
                            watchers: vec![raijin_lsp::FileSystemWatcher {
                                glob_pattern: raijin_lsp::GlobPattern::String(
        ...
        .into_response()
        .unwrap();
    fake_server.handle_notification::<raijin_lsp::notification::DidChangeWatchedFiles, _>({
    ...
    assert_eq!(
        &*file_changes.lock(),
        &[raijin_lsp::FileEvent {
            uri: raijin_lsp::Uri::from_file_path(path!("/the-root/Cargo.lock")).unwrap(),
            typ: raijin_lsp::FileChangeType::CHANGED,
        }]
    );
}
...
async fn test_reporting_fs_changes_to_language_servers(cx: &mut inazuma::TestAppContext) {
    ...
    let _out_of_worktree_buffer = project
        .update(cx, |project, cx| {
            project.open_local_buffer_via_lsp(
                raijin_lsp::Uri::from_file_path(path!("/the-registry/dep1/src/dep1.rs")).unwrap(),
                server_id,
                cx,
            )
        })
    ...
    assert_eq!(
        ...
        &[
            ...
            raijin_lsp::FileEvent {
                uri: raijin_lsp::Uri::from_file_path(path!("/the-root/src/b.rs")).unwrap(),
                typ: raijin_lsp::FileChangeType::DELETED,
            },
            raijin_lsp::FileEvent {
                uri: raijin_lsp::Uri::from_file_path(path!("/the-root/src/c.rs")).unwrap(),
                typ: raijin_lsp::FileChangeType::CREATED,
            },
            raijin_lsp::FileEvent {
                uri: raijin_lsp::Uri::from_file_path(path!("/the-root/target/y/out/y2.rs")).unwrap(),
                typ: raijin_lsp::FileChangeType::CREATED,
            },
            raijin_lsp::FileEvent {
                uri: raijin_lsp::Uri::from_file_path(path!("/the/stdlib/src/string.rs")).unwrap(),
                typ: raijin_lsp::FileChangeType::CHANGED,
            },
        ]
    );
...
async fn test_single_file_worktrees_diagnostics(cx: &mut inazuma::TestAppContext) {
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        lsp_store
            .update_diagnostics(
                LanguageServerId(0),
                raijin_lsp::PublishDiagnosticsParams {
                    uri: Uri::from_file_path(path!("/dir/a.rs")).unwrap(),
                    version: None,
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 4), raijin_lsp::Position::new(0, 5)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
        ...
        lsp_store
            .update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    ...
                    version: None,
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 8), raijin_lsp::Position::new(0, 9)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
...
async fn test_disk_based_diagnostics_progress(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        uri: Uri::from_file_path(path!("/dir/a.rs")).unwrap(),
        version: None,
        diagnostics: vec![raijin_lsp::Diagnostic {
            range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 9), raijin_lsp::Position::new(0, 10)),
            severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
        ...
        assert_eq!(
            ...
            &[DiagnosticEntryRef {
                ...
                diagnostic: &Diagnostic {
                    severity: raijin_lsp::DiagnosticSeverity::ERROR,
                    message: "undefined variable 'A'".to_string(),
                    group_id: 0,
                    is_primary: true,
    ...
    project.update(cx, |project, cx| {
        assert_eq!(
            project
                .language_servers_running_disk_based_diagnostics(cx)
                .collect::<Vec<_>>(),
            [] as [raijin_language::LanguageServerId; 0]
        );
    });
}
...
async fn test_restarting_server_with_diagnostics_published(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        ...
        version: None,
        diagnostics: vec![raijin_lsp::Diagnostic {
            range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(0, 0)),
            severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
...
async fn test_restarted_server_reporting_invalid_buffer_version(cx: &mut inazuma::TestAppContext) {
    ...
    let fake_server = fake_servers.next().await.unwrap();
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        uri: raijin_lsp::Uri::from_file_path(path!("/dir/a.rs")).unwrap(),
        version: Some(10000),
        diagnostics: Vec::new(),
    });
    cx.executor().run_until_parked();
...
async fn test_cancel_language_server_work(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server
        .start_progress_with(
            "another-token",
            raijin_lsp::WorkDoneProgressBegin {
    ...
    let cancel_notification = fake_server
        .receive_notification::<raijin_lsp::notification::WorkDoneProgressCancel>()
        .await;
    assert_eq!(
...
async fn test_toggling_enable_language_server(cx: &mut inazuma::TestAppContext) {
    ...
    fake_rust_server_1
        .receive_notification::<raijin_lsp::notification::Exit>()
        .await;
...
async fn test_transforming_diagnostics(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        ...
        diagnostics: vec![
            ...
            raijin_lsp::Diagnostic {
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 9), raijin_lsp::Position::new(1, 11)),
                severity: Some(DiagnosticSeverity::ERROR),
            ...
            raijin_lsp::Diagnostic {
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(2, 9), raijin_lsp::Position::new(2, 12)),
                severity: Some(DiagnosticSeverity::ERROR),
                source: Some("disk".to_string()),
    ...
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        ...
        diagnostics: vec![
            ...
            raijin_lsp::Diagnostic {
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 9), raijin_lsp::Position::new(0, 12)),
                severity: Some(DiagnosticSeverity::WARNING),
...
async fn test_diagnostic_summaries_cleared_on_server_restart(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        ...
        version: None,
        diagnostics: vec![raijin_lsp::Diagnostic {
            range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(0, 1)),
            severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
...
async fn test_diagnostic_summaries_cleared_on_buffer_reload(cx: &mut inazuma::TestAppContext) {
    ...
    let mut fake_servers = language_registry.register_fake_lsp(
        ...
        FakeLspAdapter {
            capabilities: raijin_lsp::ServerCapabilities {
                diagnostic_provider: Some(raijin_lsp::DiagnosticServerCapabilities::Options(
                    raijin_lsp::DiagnosticOptions {
            ...
            initializer: Some(Box::new(move |fake_server| {
                ...
                fake_server.set_request_handler::<raijin_lsp::request::DocumentDiagnosticRequest, _, _>(
                    move |_, _| {
                        let pull_count = pull_count.clone();
                        async move {
                            pull_count.fetch_add(1, atomic::Ordering::SeqCst);
                            Ok(raijin_lsp::DocumentDiagnosticReportResult::Report(
                                raijin_lsp::DocumentDiagnosticReport::Full(
                                    raijin_lsp::RelatedFullDocumentDiagnosticReport {
                                        related_documents: None,
                                        full_document_diagnostic_report:
                                            raijin_lsp::FullDocumentDiagnosticReport {
                                                result_id: None,
                                                items: Vec::new(),
                                            },
                                    },
    ...
    fake_server.notify::<raijin_lsp::notification::PublishDiagnostics>(raijin_lsp::PublishDiagnosticsParams {
        ...
        version: None,
        diagnostics: vec![raijin_lsp::Diagnostic {
            range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(0, 3)),
            severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
            message: "error in a".to_string(),
            ..Default::default()
        }],
        ...
        .update(cx, |lsp_store, cx| {
            lsp_store.as_local_mut().unwrap().edits_from_lsp(
                ...
                vec![
                    ...
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(3, 0)),
                        new_text: "
                            fn a() {
                                f10();
                            }
                    ...
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(4, 6), raijin_lsp::Position::new(4, 6)),
                        new_text: "00".into(),
                    },
                    // edit inside third function via two distinct edits
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(7, 5), raijin_lsp::Position::new(7, 5)),
                        new_text: "4000".into(),
                    },
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(7, 5), raijin_lsp::Position::new(7, 6)),
                        new_text: "".into(),
                    },
                ],
                LanguageServerId(0),
        ...
        .update(cx, |lsp_store, cx| {
            lsp_store.as_local_mut().unwrap().edits_from_lsp(
                ...
                [
                    ...
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 4), raijin_lsp::Position::new(0, 8)),
                        new_text: "a::{b, c}".into(),
                    },
                    // Reinsert the remainder of the file between the semicolon and the final
                    // newline of the file.
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 9), raijin_lsp::Position::new(0, 9)),
                        new_text: "\n\n".into(),
                    },
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 9), raijin_lsp::Position::new(0, 9)),
                    ...
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 0), raijin_lsp::Position::new(7, 0)),
                        new_text: "".into(),
                    },
                ],
                LanguageServerId(0),
        ...
        .update(cx, |lsp_store, cx| {
            lsp_store.as_local_mut().unwrap().edits_from_lsp(
                ...
                [
                    ...
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 8), raijin_lsp::Position::new(0, 4)),
                        new_text: "a::{b, c}".into(),
                    },
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 0), raijin_lsp::Position::new(99, 0)),
                        new_text: "".into(),
                    },
                    raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 9), raijin_lsp::Position::new(0, 9)),
...
async fn test_definition(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server.set_request_handler::<raijin_lsp::request::GotoDefinition, _, _>(|params, _| async move {
        let params = params.text_document_position_params;
        assert_eq!(
            params.text_document.uri.to_file_path().unwrap(),
            Path::new(path!("/dir/b.rs")),
        );
        assert_eq!(params.position, raijin_lsp::Position::new(0, 22));

        Ok(Some(raijin_lsp::GotoDefinitionResponse::Scalar(
            raijin_lsp::Location::new(
                raijin_lsp::Uri::from_file_path(path!("/dir/a.rs")).unwrap(),
                raijin_lsp::Range::new(raijin_lsp::Position::new(0, 9), raijin_lsp::Position::new(0, 10)),
            ),
        )))
    });
...
async fn test_completions_with_text_edit(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server
        .set_request_handler::<raijin_lsp::request::Completion, _, _>(|_, _| async {
                ...
                raijin_lsp::CompletionItem {
                    ...
                    text_edit: Some(raijin_lsp::CompletionTextEdit::Edit(raijin_lsp::TextEdit {
                        range: raijin_lsp::Range::new(
                            raijin_lsp::Position::new(0, text.len() as u32 - 3),
                            raijin_lsp::Position::new(0, text.len() as u32),
                        ),
...
async fn test_completions_with_edit_ranges(cx: &mut inazuma::TestAppContext) {
    ...
    // Test 1: When text_edit is None but text_edit_text exists with default edit_range
    {
        ...
        fake_server
            .set_request_handler::<raijin_lsp::request::Completion, _, _>(|_, _| async {
                Ok(Some(raijin_lsp::CompletionResponse::List(raijin_lsp::CompletionList {
                    is_incomplete: false,
                    item_defaults: Some(raijin_lsp::CompletionListItemDefaults {
                        edit_range: Some(raijin_lsp::CompletionListItemDefaultsEditRange::Range(
                            raijin_lsp::Range::new(
                                raijin_lsp::Position::new(0, text.len() as u32 - 3),
                                raijin_lsp::Position::new(0, text.len() as u32),
                            ),
                        )),
                    ...
                    items: vec![raijin_lsp::CompletionItem {
                        label: "labelText".into(),
...
async fn test_completions_without_edit_ranges(cx: &mut inazuma::TestAppContext) {
    ...
    fake_server
        .set_request_handler::<raijin_lsp::request::Completion, _, _>(|_, _| async move {
            Ok(Some(raijin_lsp::CompletionResponse::Array(vec![
                raijin_lsp::CompletionItem {
...
async fn test_apply_code_actions_with_commands(cx: &mut inazuma::TestAppContext) {
    ...
    let mut fake_language_servers = language_registry.register_fake_lsp(
        ...
        FakeLspAdapter {
            capabilities: raijin_lsp::ServerCapabilities {
                code_action_provider: Some(raijin_lsp::CodeActionProviderCapability::Options(
                    raijin_lsp::CodeActionOptions {
                        resolve_provider: Some(true),
                        ..raijin_lsp::CodeActionOptions::default()
                    },
                )),
                execute_command_provider: Some(raijin_lsp::ExecuteCommandOptions {
                    commands: vec!["_the/command".to_string()],
                    ..raijin_lsp::ExecuteCommandOptions::default()
                }),
                ..raijin_lsp::ServerCapabilities::default()
            },
            ..FakeLspAdapter::default()
    ...
    fake_server
        .set_request_handler::<raijin_lsp::request::CodeActionRequest, _, _>(|_, _| async move {
            Ok(Some(vec![
                raijin_lsp::CodeActionOrCommand::CodeAction(raijin_lsp::CodeAction {
                    title: "The code action".into(),
                    data: Some(serde_json::json!({
                        "command": "_the/command",
                    })),
                    ..raijin_lsp::CodeAction::default()
                }),
                raijin_lsp::CodeActionOrCommand::CodeAction(raijin_lsp::CodeAction {
                    title: "two".into(),
                    ..raijin_lsp::CodeAction::default()
    ...
    fake_server.set_request_handler::<raijin_lsp::request::CodeActionResolveRequest, _, _>(
        |mut action, _| async move {
            if action.data.is_some() {
                action.command = Some(raijin_lsp::Command {
    ...
    fake_server
        .set_request_handler::<raijin_lsp::request::ExecuteCommand, _, _>({
            ...
            move |params, _| {
                ...
                async move {
                    fake.server
                        .request::<raijin_lsp::request::ApplyWorkspaceEdit>(
                            raijin_lsp::ApplyWorkspaceEditParams {
                                label: None,
                                edit: raijin_lsp::WorkspaceEdit {
                                    changes: Some(
                                        [(
                                            raijin_lsp::Uri::from_file_path(path!("/dir/a.ts")).unwrap(),
                                            vec![raijin_lsp::TextEdit {
                                                range: raijin_lsp::Range::new(
...
async fn test_save_file_spawns_language_server(cx: &mut inazuma::TestAppContext) {
    ...
    assert_eq!(
        fake_rust_server
            ...
            .text_document,
        raijin_lsp::TextDocumentItem {
            uri: raijin_lsp::Uri::from_file_path(path!("/dir/file.rs")).unwrap(),
            version: 0,
            text: "".to_string(),
            language_id: "rust".to_string(),
        }
...
async fn test_buffer_is_dirty(cx: &mut inazuma::TestAppContext) {
    ...
    buffer1.update(cx, |buffer, cx| {
        ...
        assert_eq!(
            *events.lock(),
            &[
                raijin_language::BufferEvent::Edited { is_local: true },
                raijin_language::BufferEvent::DirtyChanged
            ]
        );
        events.lock().clear();
        buffer.did_save(
    ...
    buffer1.update(cx, |buffer, cx| {
        assert!(!buffer.is_dirty());
        assert_eq!(*events.lock(), &[raijin_language::BufferEvent::Saved]);
        events.lock().clear();
    ...
    fs.remove_file(path!("/dir/file3").as_ref(), Default::default())
        ...
        .unwrap();
    cx.executor().run_until_parked();
    assert_eq!(*events.lock(), &[raijin_language::BufferEvent::FileHandleChanged]);
...
async fn test_grouped_diagnostics(cx: &mut inazuma::TestAppContext) {
    ...
    let message = raijin_lsp::PublishDiagnosticsParams {
        uri: buffer_uri.clone(),
        diagnostics: vec![
            raijin_lsp::Diagnostic {
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 8), raijin_lsp::Position::new(1, 9)),
                severity: Some(DiagnosticSeverity::WARNING),
                message: "error 1".to_string(),
                related_information: Some(vec![raijin_lsp::DiagnosticRelatedInformation {
            ...
            raijin_lsp::Diagnostic {
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(2, 8), raijin_lsp::Position::new(2, 17)),
                severity: Some(DiagnosticSeverity::ERROR),
                message: "error 2".to_string(),
                related_information: Some(vec![
                    raijin_lsp::DiagnosticRelatedInformation {
                        location: raijin_lsp::Location {
                            uri: buffer_uri.clone(),
                            range: raijin_lsp::Range::new(
                                raijin_lsp::Position::new(1, 13),
                                raijin_lsp::Position::new(1, 15),
                            ),
                        },
            ...
            raijin_lsp::Diagnostic {
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 13), raijin_lsp::Position::new(1, 15)),
                severity: Some(DiagnosticSeverity::HINT),
                message: "error 2 hint 1".to_string(),
                related_information: Some(vec![raijin_lsp::DiagnosticRelatedInformation {
                    location: raijin_lsp::Location {
...
async fn test_lsp_rename_notifications(cx: &mut inazuma::TestAppContext) {
    ...
    let language_registry = project.read_with(cx, |project, _| project.languages().clone());
    language_registry.add(rust_lang());
    let watched_paths = raijin_lsp::FileOperationRegistrationOptions {
        filters: vec![
            FileOperationFilter {
                scheme: Some("file".to_owned()),
                pattern: raijin_lsp::FileOperationPattern {
                    glob: "**/*.rs".to_owned(),
                    matches: Some(raijin_lsp::FileOperationPatternKind::File),
                    options: None,
                },
            },
            FileOperationFilter {
                ...
                pattern: raijin_lsp::FileOperationPattern {
                    glob: "**/**".to_owned(),
                    matches: Some(raijin_lsp::FileOperationPatternKind::Folder),
                    options: None,
                },
            },
        ],
    ...
    let mut fake_servers = language_registry.register_fake_lsp(
        ...
        FakeLspAdapter {
            capabilities: raijin_lsp::ServerCapabilities {
                workspace: Some(raijin_lsp::WorkspaceServerCapabilities {
                    workspace_folders: None,
                    file_operations: Some(raijin_lsp::WorkspaceFileOperationsServerCapabilities {
    ...
    let expected_edit = raijin_lsp::WorkspaceEdit {
        changes: None,
        document_changes: Some(DocumentChanges::Edits({
            vec![TextDocumentEdit {
                edits: vec![raijin_lsp::Edit::Plain(raijin_lsp::TextEdit {
                    range: raijin_lsp::Range {
                        start: raijin_lsp::Position {
                            line: 0,
                            character: 1,
                        },
                        end: raijin_lsp::Position {
                            line: 0,
                            character: 3,
                        },
                    },
...
async fn test_rename(cx: &mut inazuma::TestAppContext) {
    ...
    let mut fake_servers = language_registry.register_fake_lsp(
        ...
        FakeLspAdapter {
            capabilities: raijin_lsp::ServerCapabilities {
                rename_provider: Some(raijin_lsp::OneOf::Right(raijin_lsp::RenameOptions {
    ...
    fake_server
        .set_request_handler::<raijin_lsp::request::PrepareRenameRequest, _, _>(|params, _| async move {
            assert_eq!(
                params.text_document.uri.as_str(),
                uri!("file:///dir/one.rs")
            );
            assert_eq!(params.position, raijin_lsp::Position::new(0, 7));
            Ok(Some(raijin_lsp::PrepareRenameResponse::Range(raijin_lsp::Range::new(
                raijin_lsp::Position::new(0, 6),
                raijin_lsp::Position::new(0, 9),
            ))))
        })
        .next()
        .await
    ...
    fake_server
        .set_request_handler::<raijin_lsp::request::Rename, _, _>(|params, _| async move {
            assert_eq!(
            ...
            assert_eq!(
                ...
                raijin_lsp::Position::new(0, 7)
            );
            assert_eq!(params.new_name, "THREE");
            Ok(Some(raijin_lsp::WorkspaceEdit {
                changes: Some(
                    [
                        (
                            raijin_lsp::Uri::from_file_path(path!("/dir/one.rs")).unwrap(),
                            vec![raijin_lsp::TextEdit::new(
                                raijin_lsp::Range::new(raijin_lsp::Position::new(0, 6), raijin_lsp::Position::new(0, 9)),
                                "THREE".to_string(),
                            )],
                        ),
                        (
                            raijin_lsp::Uri::from_file_path(path!("/dir/two.rs")).unwrap(),
                            vec![
                                raijin_lsp::TextEdit::new(
                                    raijin_lsp::Range::new(
                                        raijin_lsp::Position::new(0, 24),
                                        raijin_lsp::Position::new(0, 27),
                                    ),
                                    "THREE".to_string(),
                                ),
                                raijin_lsp::TextEdit::new(
                                    raijin_lsp::Range::new(
                                        raijin_lsp::Position::new(0, 35),
                                        raijin_lsp::Position::new(0, 38),
                                    ),
                                    "THREE".to_string(),
                                ),
                            ],
        ...
        match new_server_name.as_ref() {
            "TailwindServer" | "TypeScriptServer" => {
                servers_with_hover_requests.insert(
                    ...
                    new_server.set_request_handler::<raijin_lsp::request::HoverRequest, _, _>(
                        move |_, _| {
                            let name = new_server_name.clone();
                            async move {
                                Ok(Some(raijin_lsp::Hover {
                                    contents: raijin_lsp::HoverContents::Scalar(
                                        raijin_lsp::MarkedString::String(format!("{name} hover")),
                                    ),
                                    range: None,
                                }))
                            }
            ...
            "NoHoverCapabilitiesServer" => {
                let _never_handled = new_server
                    .set_request_handler::<raijin_lsp::request::HoverRequest, _, _>(|_, _| async move {
                        panic!(
...
async fn test_hovers_with_empty_parts(cx: &mut inazuma::TestAppContext) {
    ...
    let mut request_handled = fake_server.set_request_handler::<raijin_lsp::request::HoverRequest, _, _>(
        move |_, _| async move {
            Ok(Some(raijin_lsp::Hover {
                contents: raijin_lsp::HoverContents::Array(vec![
                    raijin_lsp::MarkedString::String("".to_string()),
                    raijin_lsp::MarkedString::String("      ".to_string()),
                    raijin_lsp::MarkedString::String("\n\n\n".to_string()),
                ]),
                range: None,
            }))
        },
...
async fn test_code_actions_only_kinds(cx: &mut inazuma::TestAppContext) {
    ...
    let mut request_handled = fake_server
        .set_request_handler::<raijin_lsp::request::CodeActionRequest, _, _>(move |_, _| async move {
            Ok(Some(vec![
                raijin_lsp::CodeActionOrCommand::CodeAction(raijin_lsp::CodeAction {
...
async fn test_code_actions_without_requested_kinds_do_not_send_only_filter(
    ...
    let mut request_handled = fake_server.set_request_handler::<
        raijin_lsp::request::CodeActionRequest,
        _,
        _,
    >(move |params, _| async move {
        ...
        Ok(Some(vec![raijin_lsp::CodeActionOrCommand::CodeAction(
            raijin_lsp::CodeAction {
        ...
        match new_server_name.0.as_ref() {
            "TailwindServer" | "TypeScriptServer" => {
                servers_with_actions_requests.insert(
                    new_server_name.clone(),
                    new_server.set_request_handler::<raijin_lsp::request::CodeActionRequest, _, _>(
                        move |_, _| {
                            let name = new_server_name.clone();
                            async move {
                                Ok(Some(vec![raijin_lsp::CodeActionOrCommand::CodeAction(
...
async fn test_home_dir_as_git_repository(cx: &mut inazuma::TestAppContext) {
    init_test(cx);
    let fs = FakeFs::new(cx.background_executor.clone());
    let home = raijin_paths::home_dir();
    fs.insert_tree(
        home,
        json!({
            ".git": {},
...
async fn test_repository_pending_ops_staging(
    ...
    assert_eq!(
        pending_ops_all
            .lock()
            .get(&raijin_worktree::PathKey(repo_path("a.txt").as_ref().clone()), ())
            .unwrap()
            .ops,
        vec![
...
async fn test_repository_pending_ops_stage_all(
    ...
    assert_eq!(
        pending_ops_all
            .lock()
            .get(&raijin_worktree::PathKey(repo_path("b.txt").as_ref().clone()), ())
            .unwrap()
            .ops,
        vec![
            pending_op::PendingOp {
...
mod disable_ai_settings_tests {
    ...
    async fn test_disable_ai_project_level_settings(cx: &mut TestAppContext) {
        use inazuma_settings_framework::{LocalSettingsKind, LocalSettingsPath, SettingsLocation, SettingsStore};
        use raijin_worktree::WorktreeId;
