...
mod git_traversal {
    ...
    fn check_git_statuses(
        ...
        worktree_snapshot: &raijin_worktree::Snapshot,
...
mod git_worktrees {
    use raijin_fs::FakeFs;
    use inazuma::TestAppContext;
    use raijin_project::worktrees_directory_for_repo;
    use serde_json::json;
    use inazuma_settings_framework::SettingsStore;
...
mod resolve_worktree_tests {
    use raijin_fs::FakeFs;
    use inazuma::TestAppContext;
    use raijin_project::{git_store::resolve_git_worktree_to_main_repo, linked_worktree_short_name};
    use serde_json::json;
    use std::path::{Path, PathBuf};
