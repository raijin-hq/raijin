mod go_locator {
    ...
    use raijin_dap::{DapLocator, adapters::DebugAdapterName};
    use inazuma::TestAppContext;
    use raijin_project::debugger::locators::go::{DelveLaunchRequest, GoLocator};
    use raijin_task::{HideStrategy, RevealStrategy, RevealTarget, SaveStrategy, Shell, TaskTemplate};
    #[inazuma::test]
...
mod python_locator {
    ...
    use raijin_project::debugger::locators::python::*;
    use raijin_task::{DebugScenario, TaskTemplate};
    ...
    async fn test_python_locator() {
        ...
        let build_task = TaskTemplate {
            ...
            use_new_terminal: false,
            allow_concurrent_runs: false,
            reveal: raijin_task::RevealStrategy::Always,
