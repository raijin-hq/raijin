...
use raijin_lsp::{Documentation, MarkupContent, MarkupKind};

use raijin_project::lsp_command::signature_help::SignatureHelp;
...
fn test_create_signature_help_markdown_string_1(cx: &mut TestAppContext) {
    let signature_help = raijin_lsp::SignatureHelp {
        signatures: vec![raijin_lsp::SignatureInformation {
            label: "fn test(foo: u8, bar: &str)".to_string(),
            documentation: Some(Documentation::String(
                "This is a test documentation".to_string(),
            )),
            parameters: Some(vec![
                raijin_lsp::ParameterInformation {
                    label: raijin_lsp::ParameterLabel::Simple("foo: u8".to_string()),
                    documentation: None,
                },
                raijin_lsp::ParameterInformation {
                    label: raijin_lsp::ParameterLabel::Simple("bar: &str".to_string()),
                    documentation: None,
                },
            ]),
...
fn test_create_signature_help_markdown_string_3(cx: &mut TestAppContext) {
    let signature_help = raijin_lsp::SignatureHelp {
        signatures: vec![
            raijin_lsp::SignatureInformation {
            ...
            raijin_lsp::SignatureInformation {
                ...
                parameters: Some(vec![
                    raijin_lsp::ParameterInformation {
                        label: raijin_lsp::ParameterLabel::Simple("hoge: String".to_string()),
                        documentation: None,
                    },
                    raijin_lsp::ParameterInformation {
                        label: raijin_lsp::ParameterLabel::Simple("fuga: bool".to_string()),
                        documentation: None,
                    },
                ]),
                active_parameter: None,
    ...
    let signature_help = raijin_lsp::SignatureHelp {
        signatures: vec![
            ...
            raijin_lsp::SignatureInformation {
                ...
                parameters: Some(vec![
                    raijin_lsp::ParameterInformation {
                        label: raijin_lsp::ParameterLabel::Simple("one: usize".to_string()),
                        documentation: None,
                    },
                    raijin_lsp::ParameterInformation {
                        label: raijin_lsp::ParameterLabel::Simple("two: u32".to_string()),
                        documentation: None,
                    },
                ]),
                active_parameter: None,
...
fn test_create_signature_help_markdown_string_9(cx: &mut TestAppContext) {
    let signature_help = raijin_lsp::SignatureHelp {
        signatures: vec![raijin_lsp::SignatureInformation {
            ...
            parameters: Some(vec![
                raijin_lsp::ParameterInformation {
                    label: raijin_lsp::ParameterLabel::LabelOffsets([8, 15]),
                    documentation: None,
                },
                raijin_lsp::ParameterInformation {
                    label: raijin_lsp::ParameterLabel::LabelOffsets([17, 26]),
                    documentation: None,
                },
            ]),
            active_parameter: None,
...
fn test_create_signature_help_implements_utf16_spec(cx: &mut TestAppContext) {
    let signature_help = raijin_lsp::SignatureHelp {
        signatures: vec![raijin_lsp::SignatureInformation {
            ...
            parameters: Some(vec![
                raijin_lsp::ParameterInformation {
                    label: raijin_lsp::ParameterLabel::LabelOffsets([8, 10]),
                    documentation: None,
                },
                raijin_lsp::ParameterInformation {
                    label: raijin_lsp::ParameterLabel::LabelOffsets([16, 18]),
                    documentation: None,
                },
            ]),
            active_parameter: None,
