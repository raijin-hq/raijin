...
pub type RemoteVideoFrame = std::sync::Arc<inazuma::RenderImage>;

#[cfg(target_os = "macos")]
#[derive(Clone)]
pub(crate) struct RemoteVideoFrame {}
#[cfg(target_os = "macos")]
impl Into<inazuma::SurfaceSource> for RemoteVideoFrame {
    fn into(self) -> inazuma::SurfaceSource {
        unimplemented!()
    }
}
pub(crate) fn play_remote_video_track(
    _track: &crate::RemoteVideoTrack,
    _: &inazuma::BackgroundExecutor,
