...
use inazuma_collections::{BTreeMap, HashMap, HashSet, btree_map::Entry as BTreeEntry, hash_map::Entry};
...
impl Room {
    ...
    pub fn stats_task(&self, _cx: &impl inazuma::AppContext) -> inazuma::Task<Result<SessionStats>> {
