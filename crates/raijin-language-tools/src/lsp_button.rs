...
use raijin_language::language_settings::{EditPredictionProvider, all_language_settings};
...
use raijin_language::{BinaryStatus, BufferId, ServerHealth};
use raijin_lsp::{LanguageServerId, LanguageServerName, LanguageServerSelector};
use raijin_project::{
...
use raijin_workspace::{StatusItemView, Workspace};
                    ...
                    active_editor
                        ...
                        .flat_map(|active_editor| {
                            active_editor
                                ...
                                .into_iter()
                                .filter_map(|buffer| {
                                    raijin_project::File::from_dyn(buffer.read(cx).file())
                                })
...
impl StatusItemView for LspButton {
    fn set_active_pane_item(
        &mut self,
        active_pane_item: Option<&dyn raijin_workspace::ItemHandle>,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
        if ProjectSettings::get_global(cx).global_lsp_settings.button {
        ...
        div().child(
            PopoverMenu::new("lsp-tool")
                ...
                .trigger_with_tooltip(
                    IconButton::new("raijin-lsp-tool-button", IconName::BoltOutlined)
