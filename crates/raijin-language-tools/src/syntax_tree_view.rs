...
use raijin_language::{Buffer, OwnedSyntaxLayer};
...
impl Item for SyntaxTreeView {
    ...
    fn to_item_events(_: &Self::Event, _: &mut dyn FnMut(raijin_workspace::item::ItemEvent)) {}
    ...
    fn clone_on_split(
        &self,
        _: Option<raijin_workspace::WorkspaceId>,
        window: &mut Window,
        cx: &mut Context<Self>,
