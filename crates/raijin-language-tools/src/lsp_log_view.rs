...
use raijin_editor::{Editor, EditorEvent, MultiBufferOffset, actions::MoveToEnd, scroll::Autoscroll};
use inazuma::{
...
use raijin_language::{LanguageServerId, language_settings::SoftWrap};
use raijin_lsp::{
...
use raijin_proto::toggle_lsp_logs::LogType;
use std::{any::TypeId, borrow::Cow, sync::Arc};
use raijin_ui::{Checkbox, ContextMenu, PopoverMenu, ToggleState, prelude::*};
...
impl SearchableItem for LspLogView {
    ...
    fn supported_options(&self) -> raijin_workspace::searchable::SearchOptions {
        raijin_workspace::searchable::SearchOptions {
            case: true,
            word: true,
            regex: true,
...
impl ToolbarItemView for LspLogToolbarItemView {
    fn set_active_pane_item(
        ...
        _: &mut Window,
        cx: &mut Context<Self>,
    ) -> raijin_workspace::ToolbarItemLocation {
