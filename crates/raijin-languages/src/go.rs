...
use raijin_http_client::github::latest_github_release;
pub use raijin_language::*;
use raijin_language::{
    LanguageName, LanguageToolchainStore, LspAdapterDelegate, LspInstaller,
    language_settings::LanguageSettings,
};
use raijin_lsp::{LanguageServerBinary, LanguageServerName};
...
impl LspAdapter for GoLspAdapter {
    ...
    async fn label_for_completion(
        ...
        match completion.kind.zip(completion.detail.as_ref()) {
            Some((raijin_lsp::CompletionItemKind::MODULE, detail)) => {
            ...
            Some((
                raijin_lsp::CompletionItemKind::CONSTANT | raijin_lsp::CompletionItemKind::VARIABLE,
                detail,
            )) => {
                let text = format!("{label} {detail}");
                let source =
            ...
            Some((raijin_lsp::CompletionItemKind::STRUCT, _)) => {
            ...
            Some((raijin_lsp::CompletionItemKind::INTERFACE, _)) => {
            ...
            Some((raijin_lsp::CompletionItemKind::FIELD, detail)) => {
                let text = format!("{label} {detail}");
                let source =
            ...
            Some((raijin_lsp::CompletionItemKind::FUNCTION | raijin_lsp::CompletionItemKind::METHOD, detail)) => {
    ...
    async fn label_for_symbol(
        ...
        let (text, filter_range, display_range) = match symbol.kind {
            ...
            raijin_lsp::SymbolKind::INTERFACE => {
            ...
            raijin_lsp::SymbolKind::VARIABLE => {
