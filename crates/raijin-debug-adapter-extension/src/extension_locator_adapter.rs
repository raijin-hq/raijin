...
use raijin_extension::Extension;
use inazuma::{BackgroundExecutor, SharedString};
use std::sync::Arc;
use raijin_task::{DebugScenario, SpawnInTerminal, TaskTemplate};
...
impl ExtensionLocatorAdapter {
    pub(crate) fn new(extension: Arc<dyn raijin_extension::Extension>, locator_name: Arc<str>) -> Self {
        Self {
            extension,
