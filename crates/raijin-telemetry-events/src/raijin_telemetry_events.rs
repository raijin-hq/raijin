//! See [Telemetry in Raijin](https://raijin.dev/docs/telemetry) for additional information.
...
pub struct EventRequestBody {
    /// Identifier unique to each system Raijin is installed on
    pub system_id: Option<String>,
    /// Identifier unique to each Raijin installation (differs for stable, preview, dev)
    pub installation_id: Option<String>,
    /// Identifier unique to each logged in Raijin user (randomly generated on first sign in)
    /// Identifier unique to each Raijin session (differs for each time you open Raijin)
    pub session_id: Option<String>,
    pub metrics_id: Option<String>,
    /// True for Raijin staff, otherwise false
    #[serde(skip_serializing_if = "Option::is_none")]
    pub is_staff: Option<bool>,
    /// Raijin version number
    pub app_version: String,
    pub os_name: String,
    pub os_version: Option<String>,
    pub architecture: String,
    /// Raijin release channel (stable, preview, dev)
