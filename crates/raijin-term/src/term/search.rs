...
mod tests {
    ...
    fn regex_right() {
        ...
        let mut regex = RegexSearch::new("Rai.*123").unwrap();
    ...
    fn leading_spacer() {
        ...
        let mut term = mock_term("\
            ...
            🦇xx\
        ");
        term.block_router.prompt_grid.grid[Line(0)][Column(3)].flags.insert(Flags::LEADING_WIDE_CHAR_SPACER);
    ...
    fn wide_without_spacer() {
        ...
        term.block_router.prompt_grid.grid[Line(0)][Column(0)].c = 'x';
        term.block_router.prompt_grid.grid[Line(0)][Column(1)].c = '字';
        term.block_router.prompt_grid.grid[Line(0)][Column(1)].flags = Flags::WIDE_CHAR;
