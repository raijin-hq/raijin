...
use raijin_command_palette;
use raijin_editor::{CompletionProvider, Editor};
use inazuma_fuzzy::StringMatchCandidate;
use inazuma::{Context, Entity, SharedString, Window};
use raijin_language::{self, ToOffset};
use raijin_project::{self, CompletionDisplayOptions};
...
impl CompletionProvider for ActionCompletionProvider {
    fn completions(
        ...
        let normalized_query = raijin_command_palette::normalize_action_query(&query);
            ...
            let completions: Vec<project::Completion> = matches
                ...
                .map(|m| {
                    ...
                    raijin_project::Completion {
                        ...
                        label: raijin_language::CodeLabel::plain(humanized.to_string(), None),
