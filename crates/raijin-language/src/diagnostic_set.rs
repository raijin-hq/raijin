...
impl<'a> DiagnosticGroup<'a, Anchor> {
    ...
    pub fn resolve<O: FromAnchor>(&self, buffer: &inazuma_text::BufferSnapshot) -> DiagnosticGroup<'a, O> {
        DiagnosticGroup {
            entries: self
                .entries
                .iter()
...
impl DiagnosticEntry<PointUtf16> {
    ...
    /// codeAction request
    pub fn to_lsp_diagnostic_stub(&self) -> Result<raijin_lsp::Diagnostic> {
