...
use raijin_lsp::{DiagnosticSeverity, LanguageServerId};
    ...
    Ok(
        match message.variant.context("missing operation variant")? {
            proto::operation::Variant::Edit(edit) => {
                crate::Operation::Buffer(inazuma_text::Operation::Edit(deserialize_edit_operation(edit)))
            }
        ...
        .filter_map(|diagnostic| {
            ...
            Some(DiagnosticEntry {
                ...
                diagnostic: Diagnostic {
                    ...
                    code: diagnostic.code.map(raijin_lsp::NumberOrString::from_string),
                    code_description: diagnostic
                        .code_description
                        .and_then(|s| raijin_lsp::Uri::from_str(&s).ok()),
...
pub fn lamport_timestamp_for_operation(operation: &proto::Operation) -> Option<inazuma_clock::Lamport> {
    let replica_id;
    let value;
...
pub fn serialize_lsp_edit(edit: raijin_lsp::TextEdit) -> proto::TextEdit {
...
pub fn deserialize_lsp_edit(edit: proto::TextEdit) -> Option<raijin_lsp::TextEdit> {
