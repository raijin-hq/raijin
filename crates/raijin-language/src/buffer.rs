...
pub use raijin_lsp::DiagnosticSeverity;
...
pub struct Buffer {
    ...
    reparse: Option<Task<()>>,
    parse_status: (raijin_watch::Sender<ParseStatus>, raijin_watch::Receiver<ParseStatus>),
...
impl Buffer {
    ...
    pub fn from_proto(
        ...
        this.text.set_line_ending(proto::deserialize_line_ending(
            raijin_rpc::proto::LineEnding::from_i32(message.line_ending).context("missing line_ending")?,
        ));
    ...
    #[raijin_tracing::instrument(skip_all, fields(lang = language.config.name.0.as_str()))]
    ...
    pub fn build(buffer: TextBuffer, file: Option<Arc<dyn File>>, capability: Capability) -> Self {
        ...
        Self {
            ...
            parse_status: raijin_watch::channel(ParseStatus::Idle),
    ...
    pub fn parse_status(&self) -> raijin_watch::Receiver<ParseStatus> {
...
impl BufferSnapshot {
    ...
    pub fn syntax_root_ancestor(&self, position: Anchor) -> Option<tree_sitter::Node<'_>> {
        ...
        let row = self.summary_for_anchor::<inazuma_text::PointUtf16>(&position).row as usize;
