...
use inazuma_settings_framework::{DocumentFoldingRanges, DocumentSymbols, IntoInazuma, SemanticTokens};
...
use inazuma_settings_framework::{RegisterSetting, Settings, SettingsLocation, SettingsStore, merge_from::MergeFrom};
use shellexpand;
...
impl inazuma_settings_framework::Settings for AllLanguageSettings {
    fn from_settings(content: &inazuma_settings_framework::SettingsContent) -> Self {
        ...
        for (language_name, settings) in &all_languages.languages.0 {
            ...
            inazuma_settings_framework::merge_from::MergeFrom::merge_from(&mut language_settings, settings);
            languages.insert(
