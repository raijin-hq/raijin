...
use raijin_http_client::{AsyncBody, HttpClient, Method, Request as HttpRequest};
...
///
/// Unlike `raijin_google_ai::stream_generate_content()`, this uses:
...
) -> Result<BoxStream<'static, Result<raijin_google_ai::GenerateContentResponse>>> {
