...
use raijin_ui::{Icon, IconName, Label, h_flex, prelude::*};
...
pub fn init(cx: &mut App) {
    raijin_editor::set_diagnostic_renderer(diagnostic_renderer::DiagnosticRenderer {}, cx);
    ...
    fn new(
        ...
        let project_event_subscription = cx.subscribe_in(
            ...
            |this, _project, event, window, cx| match event {
                ...
                raijin_project::Event::DiskBasedDiagnosticsFinished { language_server_id } => {
