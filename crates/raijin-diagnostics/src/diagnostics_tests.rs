...
async fn test_diagnostics(cx: &mut TestAppContext) {
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        lsp_store.update_diagnostics(language_server_id, raijin_lsp::PublishDiagnosticsParams {
            uri: uri.clone(),
            diagnostics: vec![raijin_lsp::Diagnostic{
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(7, 6),raijin_lsp::Position::new(7, 7)),
                ...
                related_information: Some(vec![raijin_lsp::DiagnosticRelatedInformation {
                    location: raijin_lsp::Location::new(uri.clone(), raijin_lsp::Range::new(raijin_lsp::Position::new(2,8),raijin_lsp::Position::new(2,9))),
                ...
                raijin_lsp::DiagnosticRelatedInformation {
                    location: raijin_lsp::Location::new(uri.clone(), raijin_lsp::Range::new(raijin_lsp::Position::new(4,6),raijin_lsp::Position::new(4,7))),
            ...
            raijin_lsp::Diagnostic{
                range: raijin_lsp::Range::new(raijin_lsp::Position::new(8, 6),raijin_lsp::Position::new(8, 7)),
                severity:Some(raijin_lsp::DiagnosticSeverity::ERROR),
                message: "use of moved value\nvalue used here after move".to_string(),
                related_information: Some(vec![raijin_lsp::DiagnosticRelatedInformation {
                    location: raijin_lsp::Location::new(uri.clone(), raijin_lsp::Range::new(raijin_lsp::Position::new(1,8),raijin_lsp::Position::new(1,9))),
                    message: "move occurs because `x` has type `Vec<char>`, which does not implement the `Copy` trait".to_string()
                },
                raijin_lsp::DiagnosticRelatedInformation {
                    location: raijin_lsp::Location::new(uri.clone(), raijin_lsp::Range::new(raijin_lsp::Position::new(3,6),raijin_lsp::Position::new(3,7))),
                    message: "value moved here".to_string()
                },
                ]),
                ..Default::default()
        ...
        lsp_store
            .update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/test/consts.rs")).unwrap(),
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(
                            raijin_lsp::Position::new(0, 15),
                            raijin_lsp::Position::new(0, 15),
                        ),
                        severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        ...
        lsp_store
            .update_diagnostics(
                server_id_1,
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(4, 0), raijin_lsp::Position::new(4, 4)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
                        message: "no method `tset`".to_string(),
                        related_information: Some(vec![raijin_lsp::DiagnosticRelatedInformation {
                            location: raijin_lsp::Location::new(
                                raijin_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                                raijin_lsp::Range::new(
                                    raijin_lsp::Position::new(0, 9),
                                    raijin_lsp::Position::new(0, 13),
                                ),
                            ),
        ...
        lsp_store
            .update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 0), raijin_lsp::Position::new(1, 1)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        ...
        lsp_store
            .update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(2, 0), raijin_lsp::Position::new(2, 1)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
        ...
        lsp_store
            .update_diagnostics(
                server_id_2,
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/test/main.rs")).unwrap(),
                    diagnostics: vec![],
                    version: None,
                },
                None,
        ...
        lsp_store
            .update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/test/main.js")).unwrap(),
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(3, 0), raijin_lsp::Position::new(3, 1)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
                        message: "warning 2".to_string(),
                        ..Default::default()
                    }],
...
async fn test_random_diagnostics_blocks(cx: &mut TestAppContext, mut rng: StdRng) {
    ...
    let mut current_diagnostics: HashMap<(PathBuf, LanguageServerId), Vec<raijin_lsp::Diagnostic>> =
        Default::default();
                ...
                lsp_store.update(cx, |lsp_store, cx| {
                    ...
                    lsp_store
                        .update_diagnostics(
                            server_id,
                            raijin_lsp::PublishDiagnosticsParams {
                                uri: raijin_lsp::Uri::from_file_path(&path).unwrap_or_else(|_| {
                                    raijin_lsp::Uri::from_str("file:///test/fallback.rs").unwrap()
                                }),
        ...
        lsp_store.update(cx, |lsp_store, cx| {
            lsp_store
                .update_diagnostics(
                    LanguageServerId(0),
                    raijin_lsp::PublishDiagnosticsParams {
                        uri: raijin_lsp::Uri::from_file_path(path!("/root/file")).unwrap(),
                        version: None,
                        diagnostics: vec![raijin_lsp::Diagnostic {
                            range: raijin_lsp::Range::new(
                                raijin_lsp::Position::new(0, 11),
                                raijin_lsp::Position::new(0, 12),
                            ),
                            severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
                ...
                .update_diagnostics(
                    ...
                    raijin_lsp::PublishDiagnosticsParams {
                        ...
                        diagnostics: vec![
                            ...
                            raijin_lsp::Diagnostic {
                                range: raijin_lsp::Range::new(
                                    raijin_lsp::Position::new(0, 25),
                                    raijin_lsp::Position::new(0, 28),
                                ),
                                severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
                                ..Default::default()
                            },
...
async fn test_diagnostics_with_links(cx: &mut TestAppContext) {
        ...
        lsp_store.update(cx, |lsp_store, cx| {
            lsp_store.update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    ...
                    version: None,
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range: raijin_lsp::Range::new(raijin_lsp::Position::new(0, 8), raijin_lsp::Position::new(0, 12)),
                        severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
    ...
    cx.run_until_parked();
    cx.update_editor(|editor, window, cx| {
        raijin_editor::hover_popover::hover(editor, &Default::default(), window, cx)
    });
    cx.run_until_parked();
...
async fn test_hover_diagnostic_and_info_popovers(cx: &mut inazuma::TestAppContext) {
    ...
    cx.update(|_, cx| {
        lsp_store.update(cx, |lsp_store, cx| {
            lsp_store.update_diagnostics(
                LanguageServerId(0),
                raijin_lsp::PublishDiagnosticsParams {
                    uri: raijin_lsp::Uri::from_file_path(path!("/root/dir/file.rs")).unwrap(),
                    version: None,
                    diagnostics: vec![raijin_lsp::Diagnostic {
                        range,
                        severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
    ...
    cx.update_editor(|editor, window, cx| raijin_editor::hover_popover::hover(editor, &Hover, window, cx));
    ...
    let range = cx.lsp_range(indoc! {"
            fn «test»() { println!(); }
        "});
    cx.set_request_handler::<raijin_lsp::request::HoverRequest, _, _>(move |_, _, _| async move {
        Ok(Some(raijin_lsp::Hover {
            contents: raijin_lsp::HoverContents::Markup(raijin_lsp::MarkupContent {
            ...
            .update_diagnostics(
                ...
                raijin_lsp::PublishDiagnosticsParams {
                    ...
                    diagnostics: vec![
                        raijin_lsp::Diagnostic {
                            range: raijin_lsp::Range::new(
                                raijin_lsp::Position::new(1, 4),
                                raijin_lsp::Position::new(1, 14),
                            ),
                            severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
                            code: Some(raijin_lsp::NumberOrString::String("no-unused-vars".to_string())),
                        ...
                        raijin_lsp::Diagnostic {
                            range: raijin_lsp::Range::new(
                                raijin_lsp::Position::new(2, 4),
                                raijin_lsp::Position::new(2, 14),
                            ),
                            severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
                            code: Some(raijin_lsp::NumberOrString::String("no-unused-vars".to_string())),
                            source: Some("eslint".to_string()),
                ...
                .update_diagnostics(
                    ...
                    raijin_lsp::PublishDiagnosticsParams {
                        ...
                        diagnostics: vec![
                            ...
                            raijin_lsp::Diagnostic {
                                range: raijin_lsp::Range::new(
                                    raijin_lsp::Position::new(0, 14),
                                    raijin_lsp::Position::new(0, 18),
                                ),
                                severity: Some(raijin_lsp::DiagnosticSeverity::INFORMATION),
                                ..Default::default()
                            },
                            raijin_lsp::Diagnostic {
                                range: raijin_lsp::Range::new(
                                    raijin_lsp::Position::new(0, 19),
                                    raijin_lsp::Position::new(0, 23),
                                ),
                                severity: Some(raijin_lsp::DiagnosticSeverity::HINT),
                                ..Default::default()
                            },
                        ],
                    },
...
async fn test_buffer_diagnostics(cx: &mut TestAppContext) {
    ...
    lsp_store.update(cx, |lsp_store, cx| {
        lsp_store.update_diagnostics(language_server_id, raijin_lsp::PublishDiagnosticsParams {
            ...
            diagnostics: vec![
                raijin_lsp::Diagnostic{
                    range: raijin_lsp::Range::new(raijin_lsp::Position::new(5, 6), raijin_lsp::Position::new(5, 7)),
                    severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
                    message: "use of moved value\nvalue used here after move".to_string(),
                ...
                raijin_lsp::Diagnostic{
                    range: raijin_lsp::Range::new(raijin_lsp::Position::new(6, 6), raijin_lsp::Position::new(6, 7)),
                    severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
                    message: "use of moved value\nvalue used here after move".to_string(),
                    related_information: Some(vec![
                        raijin_lsp::DiagnosticRelatedInformation {
        ...
        lsp_store.update_diagnostics(language_server_id, raijin_lsp::PublishDiagnosticsParams {
            uri: raijin_lsp::Uri::from_file_path(path!("/test/other.rs")).unwrap(),
            diagnostics: vec![
                raijin_lsp::Diagnostic{
                    range: raijin_lsp::Range::new(raijin_lsp::Position::new(1, 8), raijin_lsp::Position::new(1, 14)),
                    severity: Some(raijin_lsp::DiagnosticSeverity::WARNING),
                    message: "unused variable: `unused`".to_string(),
                    ..Default::default()
                },
                raijin_lsp::Diagnostic{
                    range: raijin_lsp::Range::new(raijin_lsp::Position::new(2, 4), raijin_lsp::Position::new(2, 22)),
                    severity: Some(raijin_lsp::DiagnosticSeverity::ERROR),
...
fn randomly_update_diagnostics_for_path(
    fs: &FakeFs,
    path: &Path,
    diagnostics: &mut Vec<raijin_lsp::Diagnostic>,
    next_id: &mut usize,
    rng: &mut impl Rng,
) {
...
fn random_lsp_diagnostic(
    ...
    let range = raijin_lsp::Range::new(
        raijin_lsp::Position::new(start_point.row, start_point.column),
        raijin_lsp::Position::new(end_point.row, end_point.column),
    );

    let severity = if rng.random_bool(0.5) {
        Some(raijin_lsp::DiagnosticSeverity::ERROR)
    } else {
        Some(raijin_lsp::DiagnosticSeverity::WARNING)
    };
    ...
    let related_information = if rng.random_bool(0.3) {
        ...
        for i in 0..info_count {
            ...
            let info_range = raijin_lsp::Range::new(
                raijin_lsp::Position::new(info_start_point.row, info_start_point.column),
                raijin_lsp::Position::new(info_end_point.row, info_end_point.column),
            );

            related_info.push(raijin_lsp::DiagnosticRelatedInformation {
                location: raijin_lsp::Location::new(raijin_lsp::Uri::from_file_path(path).unwrap(), info_range),
