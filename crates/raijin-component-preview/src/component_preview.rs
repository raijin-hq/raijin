...
use raijin_ui::{ButtonLike, Divider, HighlightedLabel, ListItem, ListSubHeader, Tooltip, prelude::*};
...
pub fn init(app_state: Arc<AppState>, cx: &mut App) {
    raijin_workspace::register_serializable_item::<ComponentPreview>(cx);
    ...
    cx.observe_new(move |workspace: &mut Workspace, _window, cx| {
        ...
        workspace.register_action(
            move |workspace, _: &raijin_workspace::OpenComponentPreview, window, cx| {
                let app_state = app_state.clone();
