        ...
        .map(|v| {
            ...
            match v {
                DynamicSpacingValue::Single(n) => {
                    ...
                    quote! {
                        DynamicSpacing::#variant => match ::raijin_theme::theme_settings(cx).ui_density(cx) {
                            ::raijin_theme::UiDensity::Compact => (#n - 4.0).max(0.0) / BASE_REM_SIZE_IN_PX,
                            ::raijin_theme::UiDensity::Default => #n / BASE_REM_SIZE_IN_PX,
                            ::raijin_theme::UiDensity::Comfortable => (#n + 4.0) / BASE_REM_SIZE_IN_PX,
                        }
                    }
                }
                DynamicSpacingValue::Tuple(a, b, c) => {
                    ...
                    quote! {
                        DynamicSpacing::#variant => match ::raijin_theme::theme_settings(cx).ui_density(cx) {
                            ::raijin_theme::UiDensity::Compact => #a / BASE_REM_SIZE_IN_PX,
                            ::raijin_theme::UiDensity::Default => #b / BASE_REM_SIZE_IN_PX,
                            ::raijin_theme::UiDensity::Comfortable => #c / BASE_REM_SIZE_IN_PX,
                        }
                    }
                }
            }
    ...
    let expanded = quote! {
        ...
        impl DynamicSpacing {
            ...
            pub fn px(&self, cx: &App) -> Pixels {
                let ui_font_size_f32: f32 = ::raijin_theme::theme_settings(cx).ui_font_size(cx).into();
