...
/// have `inazuma` in your dependencies for this to work.
...
pub fn derive_register_setting(input: TokenStream) -> TokenStream {
    ...
    quote! {
        inazuma_settings_framework::private::inventory::submit! {
            inazuma_settings_framework::private::RegisteredSetting {
                settings_value: || {
                    Box::new(inazuma_settings_framework::private::SettingValue::<#type_name> {
                        global_value: None,
                        local_values: Vec::new(),
                    })
                },
                from_settings: |content| Box::new(<#type_name as inazuma_settings_framework::Settings>::from_settings(content)),
