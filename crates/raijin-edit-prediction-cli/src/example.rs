...
use raijin_edit_prediction::example_spec::ExampleSpec;
use raijin_edit_prediction::udiff::OpenedBuffers;
use inazuma::Entity;
use raijin_http_client::Url;
use raijin_language::{Anchor, Buffer};
...
pub struct Example {
    ...
    /// The Raijin version used to generate this example.
    pub raijin_version: Option<String>,
