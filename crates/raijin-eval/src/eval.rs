...
use raijin_language_model::{ConfiguredModel, LanguageModel, LanguageModelRegistry, SelectedModel};
...
pub fn init(cx: &mut App) -> Arc<AgentAppState> {
    ...
    debug_adapter_raijin_extension::init(extension_host_proxy.clone(), cx);
    language_raijin_extension::init(LspAccess::Noop, extension_host_proxy, languages.clone());
