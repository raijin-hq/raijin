...
use crate::{
    Appearance, AppearanceContent, Theme, ThemeFamily,
    icon_theme::{
...
impl ThemeRegistry {
    ...
    pub fn new(assets: Box<dyn AssetSource>) -> Self {
        ...
        // Load Raijin default themes so there's always a theme available.
        registry.insert_theme_families([crate::fallback_themes::raijin_default_themes()]);
