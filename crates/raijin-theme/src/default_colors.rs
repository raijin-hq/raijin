...
const ADDED_COLOR: Oklch = Oklch { l: 0.6177, c: 0.1593, h: 147.4222, a: 1.0 };
const WORD_ADDED_COLOR: Oklch = Oklch { l: 0.6177, c: 0.1593, h: 147.4222, a: 0.35 };
const MODIFIED_COLOR: Oklch = Oklch { l: 0.7631, c: 0.1503, h: 93.0069, a: 1.0 };
const REMOVED_COLOR: Oklch = Oklch { l: 0.3659, c: 0.1412, h: 21.3235, a: 1.0 };
const WORD_DELETED_COLOR: Oklch = Oklch { l: 0.3659, c: 0.1412, h: 21.3235, a: 0.8 };
...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            scrollbar_thumb_border: inazuma::transparent_black(),
            scrollbar_track_background: inazuma::transparent_black(),
            ...
            minimap_thumb_border: inazuma::transparent_black(),
            ...
            terminal_accent: blue().light().step_9(),
            ...
            block_success_badge: grass().light().step_9(),
            block_error_badge: red().light().step_9(),
            block_running_badge: yellow().light().step_9(),
        }
    }
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            terminal_accent: blue().dark().step_9(),
            ...
            vim_helix_normal_foreground: system.transparent,
            vim_helix_select_foreground: system.transparent,
            block_success_badge: grass().dark().step_9(),
            block_error_badge: red().dark().step_9(),
            block_running_badge: yellow().dark().step_9(),
        }
    }
}
