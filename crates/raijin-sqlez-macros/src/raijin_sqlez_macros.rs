...
static SQLITE: std::sync::LazyLock<raijin_sqlez::thread_safe_connection::ThreadSafeConnection> =
    std::sync::LazyLock::new(|| {
        raijin_sqlez::thread_safe_connection::ThreadSafeConnection::new(
            ":memory:",
            false,
            None,
            Some(raijin_sqlez::thread_safe_connection::locking_queue()),
        )
    });
