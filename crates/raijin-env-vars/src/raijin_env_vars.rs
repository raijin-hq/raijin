...
/// Whether Raijin is running in stateless mode.
/// When true, Raijin will use in-memory databases instead of persistent storage.
pub static RAIJIN_STATELESS: LazyLock<bool> = bool_env_var!("RAIJIN_STATELESS");
