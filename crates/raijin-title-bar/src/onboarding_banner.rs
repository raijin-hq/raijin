...
use raijin_ui::{ButtonLike, Tooltip, prelude::*};
use inazuma_util::ResultExt;

/// Prompts the user to try newly released Raijin's features
...
fn get_dismissed(source: &str, cx: &App) -> bool {
    ...
    raijin_db::kvp::KeyValueStore::global(cx)
            ...
            .child(
                ButtonLike::new("try-a-feature")
                    ...
                    .on_click(cx.listener(|this, _, window, cx| {
                        raijin_telemetry::event!("Banner Clicked", source = this.source);
                        this.dismiss(cx);
                ...
                div().border_l_1().border_color(border_color).child(
                    IconButton::new("close", IconName::Close)
                        ...
                        .on_click(cx.listener(|this, _, _window, cx| {
                            raijin_telemetry::event!("Banner Dismissed", source = this.source);
                            this.dismiss(cx)
                        }))
                        .tooltip(|_window, cx| {
                            Tooltip::with_meta(
