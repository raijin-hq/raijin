...
impl StatusColors {
    ...
    pub fn error_border(&self, cx: &App) -> Oklch {
        self.error_border.unwrap_or(cx.theme().status().error.border)
    }
    ...
    pub fn warning_border(&self, cx: &App) -> Oklch {
        self.warning_border.unwrap_or(cx.theme().status().warning.border)
    }
    ...
    pub fn success_border(&self, cx: &App) -> Oklch {
        self.success_border.unwrap_or(cx.theme().status().created.border)
    }
