...
///
/// This assets provides icons svg files for [IconName](https://docs.rs/gpui-component/latest/inazuma_component/enum.IconName.html).
///
/// ## Usage
///
/// ```rust,no_run
/// use inazuma::*;
/// use inazuma_component_assets::Assets;
///
