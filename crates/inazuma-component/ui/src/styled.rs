...
macro_rules! font_weight {
    ($fn:ident, $const:ident) => {
        ...
        #[inline]
        fn $fn(self) -> Self {
            self.font_weight(inazuma::FontWeight::$const)
        }
    };
}

/// Extends [`inazuma::Styled`] with specific styling methods.
#[cfg_attr(feature = "inspector", inazuma::derive_inspector_reflection)]
