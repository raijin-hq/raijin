...
fn icon_for_kind(kind: Option<CompletionItemKind>) -> IconName {
    match kind {
        ...
        Some(CompletionItemKind::FUNCTION) => IconName::SquareTerminal,
        Some(CompletionItemKind::VARIABLE) => IconName::SquareTerminal,
        Some(CompletionItemKind::KEYWORD) => IconName::SquareTerminal,
