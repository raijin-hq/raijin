...
mod tests {
    ...
    #[inazuma::test]
    fn test_button_builder(_cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    fn test_button_clickable_logic(_cx: &mut inazuma::TestAppContext) {
    ...
    #[inazuma::test]
    fn test_button_variant_methods(_cx: &mut inazuma::TestAppContext) {
