...
use inazuma::{AbsoluteLength, Axis, Corner, Length, Pixels};
...
///
/// A extend version of [`inazuma::Edges`] to serialize/deserialize.
...
mod tests {
    ...
    fn test_placement() {
        ...
        assert_eq!(Placement::Top.axis(), inazuma::Axis::Vertical);
        assert_eq!(Placement::Bottom.axis(), inazuma::Axis::Vertical);
        assert_eq!(Placement::Left.axis(), inazuma::Axis::Horizontal);
        assert_eq!(Placement::Right.axis(), inazuma::Axis::Horizontal);
