use raijin_auto_update::{AutoUpdater, release_notes_url};
use raijin_editor::{Editor, MultiBuffer};
use inazuma::{
    App, DismissEvent, Entity, EventEmitter, FocusHandle, Focusable, Window, actions, prelude::*,
};
use raijin_markdown_preview::markdown_preview_view::{MarkdownPreviewMode, MarkdownPreviewView};
use raijin_release_channel::{AppVersion, ReleaseChannel};
use semver::Version;
use serde::Deserialize;
use smol::io::AsyncReadExt;
use raijin_ui::{AnnouncementToast, ListBulletItem, prelude::*};
...
fn view_release_notes_locally(
    ...
    let client = raijin_client::Client::global(cx).http_client();
