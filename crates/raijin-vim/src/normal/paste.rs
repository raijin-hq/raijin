...
use raijin_language::{Bias, SelectionGoal};
    ...
    pub fn paste(&mut self, action: &Paste, window: &mut Window, cx: &mut Context<Self>) {
        ...
        self.update_editor(cx, |vim, editor, cx| {
            ...
            editor.transact(window, cx, |editor, window, cx| {
                ...
                // unlike raijin, if you have a multi-cursor selection from vim block mode,
                ...
                let first_selection_indent_column =
                    clipboard_selections.as_ref().and_then(|raijin_selections| {
                        raijin_selections
                            .first()
...
mod test {
    ...
    use indoc::indoc;
    use raijin_language::{LanguageName, language_settings::LanguageSettingsContent};
