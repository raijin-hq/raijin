...
mod test {
    ...
    async fn test_change_w(cx: &mut inazuma::TestAppContext) {
        ...
        // see https://github.com/raijin-industries/raijin/issues/35269
        cx.simulate("c w", "tesˇt-test").await.assert_matches();
    }
    ...
    #[inazuma::test]
    async fn test_change_with_selection_spanning_expanded_diff_hunk(cx: &mut inazuma::TestAppContext) {
