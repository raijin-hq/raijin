...
use raijin_command_palette::CommandPalette;
use raijin_editor::{
...
use raijin_language::{CursorShape, Language, LanguageConfig, Point};
pub use neovim_backed_test_context::*;
use inazuma_settings_framework::SettingsStore;
use raijin_ui::Pixels;
...
use raijin_search::BufferSearchBar;
...
async fn test_end_of_document_710(cx: &mut inazuma::TestAppContext) {
    ...
    // can go to line 1 (https://github.com/raijin-industries/raijin/issues/5812)
