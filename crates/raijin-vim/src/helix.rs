...
use raijin_editor::display_map::DisplaySnapshot;
use raijin_editor::{
...
use raijin_language::{CharClassifier, CharKind, Point};
...
use raijin_workspace::searchable::FilteredSearchRange;
use raijin_workspace::searchable::{self, Direction};
    ...
    pub fn helix_select_motion(
        ...
        self.update_editor(cx, |_, editor, cx| {
            ...
            editor.change_selections(Default::default(), window, cx, |s| {
                if let Motion::RaijinSearchResult { new_selections, .. } = &motion {
...
mod test {
    ...
    use raijin_search::{ProjectSearchView, project_search};
    use serde_json::json;
