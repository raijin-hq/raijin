...
use raijin_command_palette_hooks::{CommandInterceptItem, CommandInterceptResult};
use raijin_editor::{
...
use raijin_project::ProjectPath;
use regex::Regex;
use schemars::JsonSchema;
use raijin_search::{BufferSearchBar, SearchOptions};
...
use raijin_task::{HideStrategy, RevealStrategy, SaveStrategy, SpawnInTerminal, TaskId};
...
use raijin_workspace::{Item, SaveIntent, Workspace, notifications::NotifyResultExt};
use raijin_workspace::{SplitDirection, notifications::DetachAndPromptErr};
use raijin_actions::{OpenDocs, RevealTarget};
...
fn generate_commands(_: &App) -> Vec<VimCommand> {
    vec![
        ...
        VimCommand::str(("opt", "ions"), "raijin::OpenDefaultSettings"),
