...
pub use raijin_editor::HighlightKey;
use raijin_editor::SearchSettings;
use inazuma::{Action, App, ClickEvent, FocusHandle, IntoElement, actions};
use raijin_project::search::SearchQuery;
pub use project_search::ProjectSearchView;
use raijin_ui::{ButtonStyle, IconButton, IconButtonShape};
use raijin_ui::{Tooltip, prelude::*};
use raijin_workspace::notifications::NotificationId;
use raijin_workspace::{Toast, Workspace};
pub use raijin_actions::search::ToggleIncludeIgnored;
...
impl SearchOption {
    ...
    pub fn icon(&self) -> raijin_ui::IconName {
        match self {
            SearchOption::WholeWord => raijin_ui::IconName::WholeWord,
            SearchOption::CaseSensitive => raijin_ui::IconName::CaseSensitive,
            SearchOption::IncludeIgnored => raijin_ui::IconName::Sliders,
            SearchOption::Regex => raijin_ui::IconName::Regex,
