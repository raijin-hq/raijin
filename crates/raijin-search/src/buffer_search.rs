...
use raijin_language::{Language, LanguageRegistry};
use raijin_project::{
    search::SearchQuery,
...
use raijin_actions::{outline::ToggleOutline, workspace::CopyPath, workspace::CopyRelativePath};
...
pub use raijin_actions::buffer_search::{Deploy, DeployReplace, Dismiss, FocusEditor};
...
impl EventEmitter<raijin_workspace::ToolbarItemEvent> for BufferSearchBar {}
impl Render for BufferSearchBar {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let raijin_workspace::searchable::SearchOptions {
            case,
            word,
            regex,
            replacement,
            ...
            .when(!find_in_results, |el| {
                ...
                let matches_column = h_flex()
                    ...
                    .child(render_action_button(
                        ...
                        raijin_ui::IconName::ChevronLeft,
                    ...
                    .child(render_action_button(
                        "buffer-search-nav-button",
                        raijin_ui::IconName::ChevronRight,
                        self.active_match_index
                            .is_none()
                            .then_some(ActionButtonState::Disabled),
                        "Select Next Match",
...
impl BufferSearchBar {
    ...
    pub fn register(registrar: &mut impl SearchActionsRegistrar) {
        ...
        registrar.register_handler(ForDeployed(
            |this, _: &raijin_editor::actions::Cancel, window, cx| {
    ...
    fn supported_options(&self, cx: &mut Context<Self>) -> raijin_workspace::searchable::SearchOptions {
    ...
    fn on_query_editor_event(
        ...
        match event {
            raijin_editor::EditorEvent::Focused => self.query_editor_focused = true,
            raijin_editor::EditorEvent::Blurred => self.query_editor_focused = false,
            raijin_editor::EditorEvent::Edited { .. } => {
                self.smartcase(window, cx);
                self.clear_matches(window, cx);
    ...
    fn on_replacement_editor_event(
        ...
        match event {
            raijin_editor::EditorEvent::Focused => self.replacement_editor_focused = true,
            raijin_editor::EditorEvent::Blurred => self.replacement_editor_focused = false,
            _ => {}
        }
    }
...
mod tests {
    ...
    use inazuma::{Hsla, TestAppContext, UpdateGlobal, VisualTestContext};
    use raijin_language::{Buffer, Point};
    ...
    fn init_multibuffer_test(
        ...
        let multibuffer = cx.new(|cx| {
            let mut buffer = MultiBuffer::new(raijin_language::Capability::ReadWrite);
