...
use raijin_aws_http_client::AwsHttpClient;
use raijin_bedrock::bedrock_client::Client as BedrockClient;
use raijin_bedrock::bedrock_client::config::timeout::TimeoutConfig;
use raijin_bedrock::bedrock_client::types::{
...
use inazuma_settings_framework::{BedrockAvailableModel as AvailableModel, Settings, SettingsStore};
use smol::lock::OnceCell;
use std::sync::LazyLock;
use strum::{EnumIter, IntoEnumIterator, IntoStaticStr};
use raijin_ui::{ButtonLink, ConfiguredApiCard, Divider, List, ListBulletItem, prelude::*};
...
actions!(raijin_bedrock, [Tab, TabPrev]);
    ...
    cx.background_executor()
        .spawn(async move {
            ...
            for message in messages {
                use raijin_language_model::MessageContent;
...
impl Render for ConfigurationView {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(Label::new("To use Raijin's agent with Bedrock, you can set a custom authentication strategy through your settings file or use static credentials."))
...
impl ConfigurationView {
    fn render_static_credentials_ui(&self) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(
                Label::new(format!(
                    "You can also set the {}, {} and {} environment variables (or {} for Bedrock API Key authentication) and restart Raijin.",
                    ZED_BEDROCK_ACCESS_KEY_ID_VAR.name,
                    ZED_BEDROCK_SECRET_ACCESS_KEY_VAR.name,
