...
use raijin_lmstudio::{LMSTUDIO_API_URL, ModelType, get_models};
...
impl LmStudioLanguageModel {
    fn to_lmstudio_request(
        ...
        raijin_lmstudio::ChatCompletionRequest {
            ...
            // It would be a bad UX to silently override these settings from Raijin, so we pass no temperature as a default.
