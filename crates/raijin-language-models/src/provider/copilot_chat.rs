...
use raijin_copilot::{GlobalCopilotAuth, Status};
use raijin_copilot_chat::responses as copilot_responses;
use raijin_copilot_chat::{
...
use raijin_http_client::StatusCode;
    ...
    fn configuration_view(
        ...
        cx.new(|cx| {
            raijin_copilot_ui::ConfigurationView::new(
                ...
                raijin_copilot_ui::ConfigurationMode::Chat,
                cx,
            )
        })
        .into()
...
mod tests {
    use super::*;
    use raijin_copilot_chat::responses;
