...
use raijin_ui::{ButtonLink, ConfiguredApiCard, List, ListBulletItem, prelude::*};
            ...
            match content {
                MessageContent::Text(text) | MessageContent::Thinking { text, .. } => {
                    let should_add = if message.role == Role::User {
                        ...
                        // See https://github.com/raijin-industries/raijin/issues/40097
                        !text.trim().is_empty()
                    } else {
                        !text.is_empty()
                    };
    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let api_key_section = if self.should_render_editor(cx) {
            v_flex()
                ...
                .child(Label::new("To use Raijin's agent with OpenAI, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
        ...
        let compatible_api_section = h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Label::new("Raijin also supports OpenAI-compatible models.")),
            )
            .child(
                Button::new("docs", "Learn More")
                    ...
                    .on_click(move |_, _window, cx| {
                        cx.open_url("https://raijin.dev/docs/ai/llm-providers#openai-api-compatible")
                    }),
            );
