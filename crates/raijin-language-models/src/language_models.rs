...
use raijin_language_model::{LanguageModelProviderId, LanguageModelRegistry};
...
pub fn init(user_store: Entity<UserStore>, client: Arc<Client>, cx: &mut App) {
    ...
    if let Some(extension_store) = raijin_extension_host::ExtensionStore::try_global(cx) {
        cx.subscribe(&extension_store, {
            ...
            move |extension_store, event, cx| {
                ...
                match event {
                    raijin_extension_host::Event::ExtensionInstalled(extension_id) => {
                    ...
                    raijin_extension_host::Event::ExtensionUninstalled(extension_id) => {
                        registry.update(cx, |registry, cx| {
