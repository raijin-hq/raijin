...
use raijin_ui::{IconButtonShape, Tooltip, prelude::*};
use raijin_workspace::item::{ItemBufferKind, ItemEvent, ItemHandle};
use raijin_workspace::{ToolbarItemEvent, ToolbarItemLocation, ToolbarItemView};
                    ...
                    .child(
                        Button::new("open_docs", "Learn More")
                            ...
                            .on_click(move |_event, _, cx| {
                                cx.open_url("https://raijin.dev/docs/multibuffers")
                            }),
                    ),
            )
            .child(
