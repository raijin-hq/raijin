...
pub use raijin_workspace::welcome::ShowWelcome;
use raijin_workspace::welcome::WelcomePage;
...
actions!(
    ...
    [
        ...
        SignIn,
        /// Open the user account in raijin.dev while in the onboarding flow.
        OpenAccount,
                            ...
                            .child(
                                h_flex()
                                    ...
                                    .child(
                                        h_flex()
                                            .gap_4()
                                            .child(Vector::square(VectorName::RaijinLogo, rems(2.5)))
                                            .child(
                                                v_flex()
                                                    .child(
                                                        Headline::new("Welcome to Raijin")
