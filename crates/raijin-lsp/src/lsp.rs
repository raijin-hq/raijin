...
impl LanguageServer {
    ...
    pub fn default_initialize_params(
        ...
        InitializeParams {
                        ...
                        completion_item: Some(CompletionItemCapability {
                            ...
                            resolve_support: Some(CompletionItemCapabilityResolveSupport {
                                properties: vec![
                                    ...
                                    // NB: Do not have this resolved, otherwise Raijin becomes slow to complete things
                                    // "textEdit".to_string(),
                                ],
                            }),
            ...
            client_info: raijin_release_channel::ReleaseChannel::try_global(cx).map(|release_channel| {
                ClientInfo {
                    name: release_channel.display_name().to_string(),
                    version: Some(raijin_release_channel::AppVersion::global(cx).to_string()),
                }
            }),
            locale: None,
