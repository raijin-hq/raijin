...
use raijin_http_client::{AsyncBody, HttpClient, HttpClientWithUrl};
use raijin_language::{
...
impl ExtensionStore {
    ...
    /// Installs any extensions that should be included with Raijin by default.
    ///
    ...
    fn fetch_extensions_from_api(
        ...
        let url = self.http_client.build_raijin_api_url(path, query);
