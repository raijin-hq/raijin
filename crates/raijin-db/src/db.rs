...
pub use indoc::indoc;
pub use inventory;
pub use raijin_paths::database_dir;
pub use smol;
pub use raijin_sqlez as sqlez;
pub use raijin_sqlez_macros as sqlez_macros;
pub use uuid;

pub use raijin_release_channel::RELEASE_CHANNEL;
use raijin_sqlez::domain::Migrator;
use raijin_sqlez::thread_safe_connection::ThreadSafeConnection;
...
mod tests {
    ...
    async fn test_bad_migration_panics() {
        ...
        let _bad_db = open_db::<BadDB>(
            tempdir.path(),
            raijin_release_channel::ReleaseChannel::Dev.dev_name(),
        )
        .await;
    }
