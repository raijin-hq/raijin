...
use raijin_client::EditPredictionUsage;
...
use raijin_language::{Anchor, Buffer, OffsetRangeExt};
...
impl EditPredictionIconSet {
    pub fn new(base: IconName) -> Self {
        Self {
            base,
            disabled: IconName::RaijinPredictDisabled,
            up: IconName::RaijinPredictUp,
            down: IconName::RaijinPredictDown,
            error: IconName::RaijinPredictError,
        }
    }
...
pub struct PredictedCursorPosition {
    ...
    pub anchor: raijin_language::Anchor,
...
impl PredictedCursorPosition {
    pub fn new(anchor: raijin_language::Anchor, offset: usize) -> Self {
        Self { anchor, offset }
    }

    /// Creates a predicted cursor position at an exact anchor location (offset = 0).
    pub fn at_anchor(anchor: raijin_language::Anchor) -> Self {
