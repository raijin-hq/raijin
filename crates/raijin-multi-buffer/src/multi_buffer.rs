...
///
/// See <https://raijin.dev/features#multi-buffers>
...
pub enum Event {
    ExcerptsAdded {
        ...
        excerpts: Vec<(ExcerptId, ExcerptRange<raijin_language::Anchor>)>,
    },
    ExcerptsRemoved {
        ids: Vec<ExcerptId>,
...
impl<'a> inazuma_sum_tree::Dimension<'a, inazuma_rope::ChunkSummary> for BufferOffset {
    fn zero(cx: ()) -> Self {
        BufferOffset(<usize as inazuma_sum_tree::Dimension<'a, inazuma_rope::ChunkSummary>>::zero(cx))
    }
...
struct DiffState {
    ...
    main_buffer: Option<Entity<raijin_language::Buffer>>,
...
struct DiffStateSnapshot {
    ...
    main_buffer: Option<raijin_language::BufferSnapshot>,
}
...
impl DiffState {
    ...
    fn new_inverted(
        diff: Entity<BufferDiff>,
        main_buffer: Entity<raijin_language::Buffer>,
...
pub struct RowInfo {
    ...
    pub diff_status: Option<raijin_buffer_diff::DiffHunkStatus>,
...
impl MultiBuffer {
    ...
    pub fn excerpts_for_buffer(
        ...
        buffer_id: BufferId,
        cx: &App,
    ) -> Vec<(ExcerptId, Arc<BufferSnapshot>, ExcerptRange<inazuma_text::Anchor>)> {
        let mut excerpts = Vec::new();
        let snapshot = self.read(cx);
        let mut cursor = snapshot.excerpts.cursor::<Option<&Locator>>(());
    ...
    pub fn text_anchor_for_position<T: ToOffset>(
        ...
        position: T,
        cx: &App,
    ) -> Option<(Entity<Buffer>, raijin_language::Anchor)> {
        let snapshot = self.read(cx);
    ...
    fn on_buffer_event(
        ...
        use raijin_language::BufferEvent;
...
impl MultiBufferSnapshot {
    ...
    pub fn clip_offset_utf16(
        ...
        self.clip_dimension(offset, bias, inazuma_text::BufferSnapshot::clip_offset_utf16)
    }
    ...
    pub fn point_utf16_to_offset_utf16(&self, point: PointUtf16) -> MultiBufferOffsetUtf16 {
        self.convert_dimension(point, inazuma_text::BufferSnapshot::point_utf16_to_offset_utf16)
    }
    ...
    pub fn context_range_for_excerpt(&self, excerpt_id: ExcerptId) -> Option<Range<inazuma_text::Anchor>> {
    ...
    pub fn excerpts(
        &self,
    ) -> impl Iterator<Item = (ExcerptId, &BufferSnapshot, ExcerptRange<inazuma_text::Anchor>)> {
        self.excerpts
            .iter()
    ...
    pub fn runnable_ranges(
        &self,
        range: Range<Anchor>,
    ) -> impl Iterator<Item = (Range<Anchor>, raijin_language::RunnableRange)> + '_ {
        let range = range.start.to_offset(self)..range.end.to_offset(self);
        self.lift_buffer_metadata(range, move |buffer, range| {
            Some(
                buffer
