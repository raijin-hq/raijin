...
use indoc::indoc;
use raijin_language::{Buffer, Rope};
...
struct ReferenceMultibuffer {
    ...
    inverted_diffs: HashMap<BufferId, (Entity<BufferDiff>, Entity<raijin_language::Buffer>)>,
}
...
impl ReferenceMultibuffer {
    ...
    fn expand_diff_hunks(&mut self, excerpt_id: ExcerptId, range: Range<inazuma_text::Anchor>, cx: &App) {
        let excerpt = self
            .excerpts
            .iter_mut()
