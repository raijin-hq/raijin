...
use raijin_ui::{FluentBuilder, TintColor, prelude::*};
use raijin_workspace::WorkspaceSettings;
...
pub struct RaijinPromptRenderer {
    _level: PromptLevel,
...
impl Render for RaijinPromptRenderer {
...
impl EventEmitter<PromptResponse> for RaijinPromptRenderer {}

impl Focusable for RaijinPromptRenderer {
