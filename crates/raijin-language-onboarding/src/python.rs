...
use raijin_ui::{Banner, FluentBuilder as _, prelude::*};
use raijin_workspace::{ToolbarItemEvent, ToolbarItemLocation, ToolbarItemView, Workspace};
...
impl BasedPyrightBanner {
    pub fn new(workspace: &Workspace, cx: &mut Context<Self>) -> Self {
        let subscription = cx.subscribe(workspace.project(), |this, _, event, _| {
            if let raijin_project::Event::LanguageServerAdded(_, name, _) = event
                && name == "basedpyright"
            {
                            ...
                            h_flex()
                                ...
                                .child(
                                    Button::new("learn-more", "Learn More")
                                        ...
                                        .on_click(|_, _, cx| {
                                            cx.open_url("https://raijin.dev/docs/languages/python")
                                        }),
                                )
