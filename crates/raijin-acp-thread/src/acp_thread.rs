...
mod mention;
mod terminal;
use raijin_action_log::{ActionLog, ActionLogTelemetry};
...
use inazuma::{AppContext, AsyncApp, Context, Entity, EventEmitter, SharedString, Task, WeakEntity};
use itertools::Itertools;
use raijin_language::language_settings::FormatOnSave;
use raijin_language::{Anchor, Buffer, BufferSnapshot, LanguageRegistry, Point, ToPoint, text_diff};
use raijin_markdown::Markdown;
pub use mention::*;
use raijin_project::lsp_store::{FormatTrigger, LspFormatTarget};
use raijin_project::{AgentLocation, Project, git_store::GitStoreCheckpoint};
...
pub enum TerminalProviderEvent {
    Created {
        ...
        terminal: Entity<::raijin_terminal::Terminal>,
    },
    Output {
        terminal_id: acp::TerminalId,
        data: Vec<u8>,
...
impl AcpThread {
    pub fn new(
        ...
        action_log: Entity<ActionLog>,
        session_id: acp::SessionId,
        mut prompt_capabilities_rx: raijin_watch::Receiver<acp::PromptCapabilities>,
        cx: &mut Context<Self>,
    ) -> Self {
...
mod tests {
    ...
    use indoc::indoc;
    use raijin_project::{AgentId, FakeFs, Fs};
    ...
    #[inazuma::test]
    async fn test_terminal_output_buffered_before_created_renders(cx: &mut inazuma::TestAppContext) {
        init_test(cx);
        ...
        let lower = cx.new(|cx| {
            let builder = ::raijin_terminal::TerminalBuilder::new_display_only(
                ::raijin_terminal::terminal_settings::CursorShape::default(),
                ::raijin_terminal::terminal_settings::AlternateScroll::On,
                None,
                0,
                cx.background_executor(),
                PathStyle::local(),
    ...
    #[inazuma::test]
    async fn test_terminal_output_and_exit_buffered_before_created(cx: &mut inazuma::TestAppContext) {
        init_test(cx);
    ...
    async fn test_terminal_kill_allows_wait_for_exit_to_complete(cx: &mut inazuma::TestAppContext) {
        ...
        let builder = cx
            .update(|cx| {
                ::raijin_terminal::TerminalBuilder::new(
                    None,
                    None,
    ...
    impl AgentConnection for FakeAgentConnection {
        ...
        fn authenticate(&self, method: acp::AuthMethodId, _cx: &mut App) -> Task<inazuma::Result<()>> {
