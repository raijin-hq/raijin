...
impl Terminal {
    ...
    pub fn inner(&self) -> &Entity<raijin_terminal::Terminal> {
        &self.terminal
    }
...
pub async fn create_terminal_entity(
    ...
    cx: &mut AsyncApp,
) -> Result<Entity<raijin_terminal::Terminal>> {
    ...
    let (task_command, task_args) = raijin_task::ShellBuilder::new(&shell, is_windows)
