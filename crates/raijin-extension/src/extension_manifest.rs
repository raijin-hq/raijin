...
pub struct AgentServerManifestEntry {
    ...
    /// use Raijin's managed Node.js runtime instead of relying on the user's PATH:
    /// ```toml
...
impl TargetConfig {
    pub fn from_proto(proto: raijin_proto::ExternalExtensionAgentTarget) -> Self {
        Self {
    ...
    pub fn to_proto(&self) -> raijin_proto::ExternalExtensionAgentTarget {
        raijin_proto::ExternalExtensionAgentTarget {
...
pub struct LanguageServerManifestEntry {
    ...
    #[serde(default)]
    pub code_action_kinds: Option<Vec<raijin_lsp::CodeActionKind>>,
}
