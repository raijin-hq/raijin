...
use raijin_ui::{CopyButton, Tooltip, prelude::*};
        ...
        self.show_notification(NotificationId::unique::<PortalError>(), cx, |cx| {
            cx.new(|cx| {
                ErrorMessagePrompt::new(err.to_string(), cx).with_link_button(
                    "See docs",
                    "https://raijin.dev/docs/linux#i-cant-open-any-files",
                )
            })
        });
    }
...
pub struct LanguageServerPrompt {
    ...
    request: Option<raijin_project::LanguageServerPromptRequest>,
...
impl LanguageServerPrompt {
    pub fn new(request: raijin_project::LanguageServerPromptRequest, cx: &mut App) -> Self {
            ...
            .child(
                v_flex()
                        ...
                        h_flex()
                            ...
                            .child(
                                h_flex()
                                    ...
                                    .child(
                                        raijin_ui::IconButton::new("close", raijin_ui::IconName::Close).on_click(
                    ...
                    .when_some(self.label_and_url_button.clone(), |elm, (label, url)| {
                        elm.child(
                            div().mt_2().child(
                                raijin_ui::Button::new("error_message_prompt_notification_button", label)
...
pub mod simple_message_notification {
    ...
    use raijin_ui::{WithScrollbar, prelude::*};
...
mod tests {
    ...
    use raijin_project::{LanguageServerPromptRequest, Project};
