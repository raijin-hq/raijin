...
use raijin_git::Clone as GitClone;
...
use raijin_ui::{ButtonLike, Divider, DividerColor, KeyBinding, Vector, VectorName, prelude::*};
use inazuma_util::ResultExt;
use raijin_actions::{Extensions, OpenOnboarding, OpenSettings, agent, command_palette};
...
mod persistence {
    ...
    raijin_db::static_connection!(WelcomePagesDb, [WorkspaceDb]);
