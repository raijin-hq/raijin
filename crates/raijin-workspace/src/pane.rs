...
use anyhow::Result;
use inazuma_collections::{BTreeSet, HashMap, HashSet, VecDeque};
...
use raijin_language::{Capability, DiagnosticSeverity};
use parking_lot::Mutex;
use raijin_project::{DirectoryLister, Project, ProjectEntryId, ProjectPath, WorktreeId};
    ...
    fn render_tab(
        ...
        let tab = Tab::new(ix)
            ...
            .close_side(match close_side {
                ClosePosition::Left => raijin_ui::TabCloseSide::Start,
                ClosePosition::Right => raijin_ui::TabCloseSide::End,
            })
                                ...
                                .when(is_local, |menu| {
                                    menu.when_some(reveal_path, |menu, reveal_path| {
                                        menu.separator().entry(
                                            ...
                                            Some(Box::new(
                                                raijin_actions::editor::RevealInFileManager,
                                            )),
                                ...
                                .when(visible_in_project_panel, |menu| {
                                    menu.entry(
                                        ...
                                        window.handler_for(&pane, move |pane, _, cx| {
                                            pane.project
                                                .update(cx, |_, cx| {
                                                    cx.emit(raijin_project::Event::RevealInProjectPanel(
...
mod tests {
    ...
    use inazuma::{AppContext, Axis, TestAppContext, VisualTestContext, size};
    ...
    impl Item for CustomDropHandlingItem {
        ...
        fn tab_content_text(&self, _detail: usize, _cx: &App) -> inazuma::SharedString {
    ...
    async fn test_drag_tab_to_middle_tab_with_mouse_events(cx: &mut TestAppContext) {
        use inazuma::{Modifiers, MouseButton, MouseDownEvent, MouseMoveEvent, MouseUpEvent};
    ...
    async fn test_middle_click_pinned_tab_does_not_close(cx: &mut TestAppContext) {
        use inazuma::{Modifiers, MouseButton, MouseDownEvent, MouseUpEvent};
