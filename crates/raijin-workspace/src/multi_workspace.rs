...
use raijin_ui::{ContextMenu, right_click_menu};
...
pub fn sidebar_side_context_menu(
    ...
    cx: &App,
) -> raijin_ui::RightClickMenu<ContextMenu> {
        ...
        ContextMenu::build(window, cx, move |mut menu, _, _cx| {
            ...
            for (position, label) in positions {
                ...
                menu = menu.toggleable_entry(
                    ...
                    None,
                    move |_window, cx| {
                        inazuma_settings_framework::update_settings_file(fs.clone(), cx, move |settings, _cx| {
                            settings
                                .agent
...
impl MultiWorkspace {
    ...
    pub fn new(workspace: Entity<Workspace>, window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        let settings_subscription =
            cx.observe_global_in::<inazuma_settings_framework::SettingsStore>(window, |this, window, cx| {
    ...
    pub fn toggle_modal<V: ModalView, B>(
        ...
        B: FnOnce(&mut Window, &mut inazuma::Context<V>) -> V,
    {
        self.workspace().update(cx, |workspace, cx| {
