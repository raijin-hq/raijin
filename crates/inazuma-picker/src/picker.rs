...
use raijin_ui_input::{ErasedEditor, ErasedEditorEvent};
use raijin_workspace::{ModalView, item::Settings};
...
pub trait PickerDelegate: Sized + 'static {
    ...
    // This avoids a flash of an empty command-palette on cmd-shift-p, and lets raijin_workspace::SendKeystrokes
