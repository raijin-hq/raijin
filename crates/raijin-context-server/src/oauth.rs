...
use raijin_http_client::{AsyncBody, HttpClient, Request};
...
pub async fn perform_dcr(
    ...
    let request = Request::builder()
        .method(raijin_http_client::http::Method::POST)
...
async fn fetch_json<T: serde::de::DeserializeOwned>(
    ...
    let request = Request::builder()
        .method(raijin_http_client::http::Method::GET)
        .uri(url.as_str())
        .header("Accept", "application/json")
...
mod tests {
    use super::*;
    use raijin_http_client::Response;
    ...
    fn make_fake_http_client(
        handler: impl Fn(
            raijin_http_client::Request<AsyncBody>,
        ) -> std::pin::Pin<
        ...
        raijin_http_client::FakeHttpClient::create(handler) as Arc<dyn HttpClient>
    }
