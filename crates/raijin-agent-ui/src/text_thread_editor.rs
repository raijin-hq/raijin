...
use raijin_editor::{FoldPlaceholder, display_map::CreaseId};
use raijin_fs::Fs;
...
use raijin_project::{Project, Worktree};
use raijin_project::{ProjectPath, lsp_store::LocalLspAdapterDelegate};
...
use raijin_actions::agent::{AddSelectionToThread, PasteRaw, ToggleModelSelector};

use crate::CycleFavoriteModels;

use crate::{slash_command::SlashCommandCompletionProvider, slash_command_picker};
use raijin_assistant_text_thread::{
...
mod tests {
    use super::*;
    use raijin_editor::{MultiBufferOffset, SelectionEffects};
