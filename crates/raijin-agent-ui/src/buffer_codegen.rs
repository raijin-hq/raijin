...
use raijin_language::{Buffer, IndentKind, LanguageName, Point, TransactionId, line_diff};
...
impl CodegenAlternative {
    ...
    pub fn handle_stream(
        ...
        // as in https://github.com/raijin-industries/raijin/issues/39088
...
mod tests {
    ...
    use raijin_language_model::fake_provider::FakeLanguageModel;
    use raijin_language_model::{
    ...
    use raijin_languages::rust_lang;
    use rand::prelude::*;
    ...
    async fn test_allows_model_to_output_backticks(cx: &mut TestAppContext) {
        init_test(cx);
        let text = "- Improved; `cmd+click` behavior. Now requires `cmd` to be pressed before the click starts or it doesn't run. ([#44579](https://github.com/raijin-industries/raijin/pull/44579); thanks [Zachiah](https://github.com/Zachiah))";
