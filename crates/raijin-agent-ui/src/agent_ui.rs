...
// TODO(phase20): terminal_inline_assistant depends on raijin-terminal-view which will be built in Phase 20
...
use raijin_feature_flags::{AgentV2FeatureFlag, FeatureFlagAppExt as _};
use raijin_fs::Fs;
...
use raijin_project::{AgentId, DisableAiSettings};
...
fn update_command_palette_filter(cx: &mut App) {
    ...
    CommandPaletteFilter::update_global(cx, |filter, _| {
        ...
        if disable_ai {
            ...
            filter.hide_action_types(&[TypeId::of::<raijin_actions::OpenRaijinPredictOnboarding>()]);
        } else {
            if agent_enabled {
