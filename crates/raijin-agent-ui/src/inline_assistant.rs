use raijin_language_model::AnthropicEventData;
use raijin_language_model::report_anthropic_event;
use std::cmp;
use std::mem;
use std::ops::Range;
use std::rc::Rc;
...
use raijin_editor::SelectionEffects;
...
use raijin_language::{Buffer, Point, Selection, TransactionId};
use raijin_language_model::{ConfigurationError, ConfiguredModel, LanguageModelRegistry};
use raijin_multi_buffer::MultiBufferRow;
use parking_lot::Mutex;
use raijin_project::{CodeAction, DisableAiSettings, LspAction, Project, ProjectTransaction};
use raijin_prompt_store::{PromptBuilder, PromptStore};
use inazuma_settings_framework::{Settings, SettingsStore};

use raijin_terminal_view::{TerminalView, terminal_panel::TerminalPanel};
...
impl InlineAssistant {
    ...
    pub fn inline_assist(
        ...
        action: &raijin_actions::assistant::InlineAssist,
        window: &mut Window,
        ...
        let handle_assist =
            |window: &mut Window, cx: &mut Context<Workspace>| match inline_assist_target {
                ...
                InlineAssistTarget::Terminal(_active_terminal) => {
                    // TODO(phase20): TerminalInlineAssistant — depends on raijin-terminal-view
                }
            };
...
pub mod evals {
    ...
    use raijin_editor::{Editor, MultiBuffer, MultiBufferOffset};
    ...
    use raijin_language_model::{LanguageModelRegistry, SelectedModel};
    use raijin_project::Project;
    use raijin_prompt_store::PromptBuilder;
