...
use raijin_language::{Buffer, Capability, OffsetRangeExt, Point};
...
use raijin_ui::{CommonAnimationExt, IconButtonShape, KeyBinding, Tooltip, prelude::*, vertical_divider};
...
use raijin_actions::assistant::ToggleFocus;
...
impl Item for AgentDiffPane {
    ...
    fn tab_icon(&self, _window: &Window, _cx: &App) -> Option<Icon> {
        Some(Icon::new(IconName::RaijinAssistant).color(Color::Muted))
    }
