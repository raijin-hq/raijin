...
use raijin_rpc::{AnyProtoClient, proto::Envelope};
use std::{
    path::PathBuf,
    sync::{
        Arc,
...
impl RemoteClientDelegate for MockDelegate {
    fn ask_password(
        &self,
        _prompt: String,
        _sender: futures::channel::oneshot::Sender<raijin_askpass::EncryptedPassword>,
        _cx: &mut AsyncApp,
    ) {
    ...
    fn download_server_binary_locally(
        ...
        _release_channel: raijin_release_channel::ReleaseChannel,
