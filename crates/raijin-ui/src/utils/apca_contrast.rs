...
///
/// https://github.com/Myndex/apca-w3
pub fn apca_contrast(text_color: Oklch, background_color: Oklch) -> f32 {
...
mod tests {
    ...
    fn hsla(h: f32, s: f32, l: f32, a: f32) -> Oklch {
        Oklch {
            l,
            c: s,
            h: h * 360.0,
    ...
    fn hsla_from_hex(hex: u32) -> Oklch {
        ...
        if max == min {
            ...
            // hue in 0..1 fraction, convert to degrees for Oklch
            let h_frac = if max == r {
