...
pub fn calculate_contrast_ratio(fg: Oklch, bg: Oklch) -> f32 {
...
fn relative_luminance(color: Oklch) -> f32 {
...
mod tests {
    ...
    fn test_contrast_ratio_formula() {
        ...
        let mid_gray = oklch(0.5982, 0.0, 0.0);
        ...
        let red = oklch(0.628, 0.2577, 29.2339);
