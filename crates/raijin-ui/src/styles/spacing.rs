...
use raijin_theme::UiDensity;
use raijin_ui_macros::derive_dynamic_spacing;

// Derives [DynamicSpacing]. See [raijin_ui_macros::derive_dynamic_spacing].
//
...
pub fn ui_density(cx: &mut App) -> UiDensity {
    raijin_theme::theme_settings(cx).ui_density(cx)
}
