...
use crate::{
    ActiveTheme, Icon, Selectable, Sizable, Size, StyleSized,
    Divider,
    h_flex,
    Input,
    Popover,
        ...
        v_flex()
            ...
            .child(
                TabBar::new("mode")
                    ...
                    .child(crate::components::tab::Tab::new("palette-tab").label(t!("ColorPicker.Palette")))
                    .child(crate::components::tab::Tab::new("hsla-tab").label(t!("ColorPicker.HSLA"))),
            )
