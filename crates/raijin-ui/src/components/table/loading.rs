use crate::{h_flex, Skeleton, v_flex, ActiveTheme, Size};
use inazuma::{prelude::FluentBuilder as _, IntoElement, ParentElement as _, RenderOnce, Styled};
    ...
    fn render(self, _: &mut inazuma::Window, cx: &mut inazuma::App) -> impl IntoElement {
        ...
        h_flex()
            ...
            .when(!self.header, |this| {
                this.border_t_1().border_color(cx.theme().colors().border_variant)
            })
            .child(
                h_flex()
                    .gap_3()
