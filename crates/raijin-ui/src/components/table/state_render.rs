...
use crate::{
    ActiveTheme, ElementExt, Icon, IconName, Scrollbar, StyleSized as _, StyledExt,
    h_flex,
};
use inazuma::{
        ...
        h_flex()
            ...
            .child(
                div()
                    ...
                    .group_hover(&group_id, |this| this.bg(cx.theme().colors().border).h_full())
                    .w(px(1.)),
            )
    ...
    pub(super) fn render_sort_icon(
        ...
        Some(
            div()
                ...
                .child(Icon::new(icon).size_3().text_color(cx.theme().colors().secondary_foreground)),
        )
    }
        ...
        if row_ix < rows_count {
            ...
            tr.h_flex()
                ...
                .when(need_render_border, |this| {
                    this.border_b_1().border_color(cx.theme().colors().border_variant)
                })
                .when(is_stripe_row, |this| this.bg(cx.theme().colors().background))
                .refine_style(&style)
                .hover(|this| {
