...
/// It also contains an arrow icon to communicate the link takes you out of Raijin.
///
/// # Usage Example
///
/// ```
/// use raijin_ui::ButtonLink;
///
            ...
            v_flex()
                ...
                .child(
                    example_group(vec![single_example(
                        "Simple",
                        ButtonLink::new("raijin.dev", "https://raijin.dev").into_any_element(),
                    )])
                    .vertical(),
                )
                .into_any_element(),
