...
impl NotificationType {
    fn icon(&self, cx: &App) -> Icon {
        match self {
            ...
            Self::Success => Icon::new(IconName::Check).text_color(cx.theme().status().success.color),
            Self::Warning => Icon::new(IconName::Warning).text_color(cx.theme().status().warning.color),
