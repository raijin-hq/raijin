use crate::{
    GroupBoxVariant, Icon, IconName, Input, InputState, Sizable, SettingGroup, SettingPage, Sidebar,
    SidebarMenu, SidebarMenuItem, Size, StyledExt, h_resizable, resizable_panel,
};
use inazuma::{
