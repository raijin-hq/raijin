...
use raijin_cloud_api_client::ClientApiError;
use raijin_cloud_api_types::OrganizationId;
use raijin_cloud_api_types::websocket_protocol::MessageToClient;
use raijin_cloud_llm_client::{EXPIRED_LLM_TOKEN_HEADER_NAME, OUTDATED_LLM_TOKEN_HEADER_NAME};
use inazuma::{
...
impl NeedsLlmTokenRefresh for raijin_http_client::Response<raijin_http_client::AsyncBody> {
    fn needs_llm_token_refresh(&self) -> bool {
...
impl RefreshLlmTokenListener {
    ...
    fn new(client: Arc<Client>, user_store: Entity<UserStore>, cx: &mut Context<Self>) -> Self {
        ...
        let subscription = cx.subscribe(&user_store, |this, _user_store, event, cx| {
            if matches!(event, raijin_client::user::Event::OrganizationChanged) {
