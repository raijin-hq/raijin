...
use raijin_feature_flags::{AcpBetaFeatureFlag, FeatureFlagAppExt as _};
use futures::AsyncBufReadExt as _;
use futures::io::BufReader;
use raijin_project::agent_server_store::AgentServerCommand;
use raijin_project::{AgentId, Project};
use serde::Deserialize;
use inazuma_settings_framework::Settings as _;
use raijin_task::{ShellBuilder, SpawnInTerminal};
...
use raijin_acp_thread::{AcpThread, AuthRequired, LoadError, TerminalProviderEvent};
use raijin_terminal::TerminalBuilder;
use raijin_terminal::terminal_settings::{AlternateScroll, CursorShape, TerminalSettings};
        ...
        let response = connection
            .initialize(
                acp::InitializeRequest::new(acp::ProtocolVersion::V1)
                    ...
                    .client_info(
                        acp::Implementation::new("raijin", version)
