...
use raijin_editor::{Editor, EditorEvent};
...
use raijin_platform_title_bar::PlatformTitleBar;
use raijin_project::{Project, ProjectPath, Worktree, WorktreeId};
...
trait AnySettingField {
    ...
    fn file_set_in(&self, file: SettingsUiFile, cx: &App) -> (inazuma_settings_framework::SettingsFile, bool);
...
impl SettingsUiFile {
    ...
    fn from_settings(file: inazuma_settings_framework::SettingsFile) -> Option<Self> {
        Some(match file {
            ...
            inazuma_settings_framework::SettingsFile::Project(location) => SettingsUiFile::Project(location),
            inazuma_settings_framework::SettingsFile::Server => SettingsUiFile::Server("todo: server name"),
    ...
    fn to_settings(&self) -> inazuma_settings_framework::SettingsFile {
        match self {
            ...
            SettingsUiFile::Project(location) => inazuma_settings_framework::SettingsFile::Project(location.clone()),
...
impl SettingsWindow {
    fn new(
        ...
        let list_state = inazuma::ListState::new(0, inazuma::ListAlignment::Top, px(0.0)).measure_all();
            ...
            SettingsStore::global(cx).error_for_file(self.current_file.to_settings())
        {
            ...
            warning_banner = v_flex()
                ...
                .map(|this| match &error.migration_status {
                    inazuma_settings_framework::MigrationStatus::Succeeded => this.child(banner(
                    ...
                    inazuma_settings_framework::MigrationStatus::Failed { error: err } if !parse_failed => this
                        .child(banner(
                    ...
                    move |theme_name, window, cx| {
                        update_settings_file(
                            ...
                            move |settings, _cx| {
                                (field.write)(
                                    settings,
                                    Some(inazuma_settings_framework::IconThemeName(theme_name.into())),
                                );
                            },
                        )
                        .log_err(); // todo(settings_ui) don't log err
