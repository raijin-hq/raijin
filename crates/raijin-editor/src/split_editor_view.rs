...
use inazuma::{
    ...
    Entity, GlobalElementId, Oklch, InspectorElementId, IntoElement, LayoutId, Length,
...
use raijin_ui::scrollbars::ShowScrollbar;
...
impl SplitBufferHeadersElement {
    fn rem_size(&self) -> Option<Pixels> {
        match self.style.text.font_size {
            ...
            AbsoluteLength::Rems(rems) => Some(rems.to_pixels(raijin_ui::BASE_REM_SIZE_IN_PX.into())),
        }
    }
