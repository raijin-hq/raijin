...
use raijin_multi_buffer::{Anchor, ExcerptId, MultiBufferSnapshot};
use raijin_project::{
...
pub mod tests {
    ...
    use raijin_language::language_settings::InlayHintKind;
    use raijin_language::{Capability, FakeLspAdapter};
    use raijin_language::{Language, LanguageConfig, LanguageMatcher};
    use languages::rust_lang;
    use raijin_lsp::{DEFAULT_LSP_REQUEST_TIMEOUT, FakeLanguageServer};
    use raijin_multi_buffer::{MultiBuffer, MultiBufferOffset, PathKey};
    use parking_lot::Mutex;
    use pretty_assertions::assert_eq;
    use raijin_project::{FakeFs, Project};
    use serde_json::json;
    use inazuma_settings_framework::{AllLanguageSettingsContent, InlayHintSettingsContent, SettingsStore};
    use std::ops::Range;
    use std::sync::Arc;
    ...
    async fn test_basic_cache_update_with_duplicate_hints(cx: &mut inazuma::TestAppContext) {
                ...
                move |params, _| {
                    ...
                    async move {
                        ...
                        assert_eq!(
                            ...
                            raijin_lsp::Uri::from_file_path(file_with_hints).unwrap(),
                        );
                        Ok(Some(vec![raijin_lsp::InlayHint {
                            position: raijin_lsp::Position::new(0, i),
                            label: raijin_lsp::InlayHintLabel::String(i.to_string()),
                            kind: None,
                            text_edits: None,
                            tooltip: None,
                            padding_left: None,
        ...
        fake_server
            .request::<raijin_lsp::request::InlayHintRefreshRequest>((), DEFAULT_LSP_REQUEST_TIMEOUT)
            .await
            .into_response()
    ...
    async fn test_cache_update_on_lsp_completion_tasks(cx: &mut inazuma::TestAppContext) {
            ...
            fake_server.set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(
                move |params, _| {
                    ...
                    async move {
                        ...
                        Ok(Some(vec![raijin_lsp::InlayHint {
                            position: raijin_lsp::Position::new(0, current_call_id),
                            label: raijin_lsp::InlayHintLabel::String(current_call_id.to_string()),
                            kind: None,
                            text_edits: None,
                            tooltip: None,
                            padding_left: None,
        ...
        fake_server
            .request::<raijin_lsp::request::WorkDoneProgressCreate>(
                raijin_lsp::WorkDoneProgressCreateParams {
                    token: raijin_lsp::ProgressToken::Number(progress_token),
                },
        ...
        cx.executor().run_until_parked();
        fake_server.notify::<raijin_lsp::notification::Progress>(raijin_lsp::ProgressParams {
            token: raijin_lsp::ProgressToken::Number(progress_token),
            value: raijin_lsp::ProgressParamsValue::WorkDone(raijin_lsp::WorkDoneProgress::Begin(
                raijin_lsp::WorkDoneProgressBegin::default(),
            )),
        });
        cx.executor().run_until_parked();
        ...
        fake_server.notify::<raijin_lsp::notification::Progress>(raijin_lsp::ProgressParams {
            token: raijin_lsp::ProgressToken::Number(progress_token),
            value: raijin_lsp::ProgressParamsValue::WorkDone(raijin_lsp::WorkDoneProgress::End(
                raijin_lsp::WorkDoneProgressEnd::default(),
            )),
        });
        cx.executor().run_until_parked();
                ...
                FakeLspAdapter {
                    ...
                    initializer: Some(Box::new({
                        move |fake_server| {
                            ...
                            fake_server
                                .set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(
                                    move |params, _| {
                                        let i = match name {
                                            "Rust" => {
                                                assert_eq!(
                                                    params.text_document.uri,
                                                    raijin_lsp::Uri::from_file_path(path!("/a/main.rs"))
                                                        .unwrap(),
                                                );
                                            ...
                                            "Markdown" => {
                                                assert_eq!(
                                                    params.text_document.uri,
                                                    raijin_lsp::Uri::from_file_path(path!("/a/other.md"))
                                                        .unwrap(),
                                                );
                        ...
                        async move {
                            ...
                            Ok(Some(vec![
                                raijin_lsp::InlayHint {
                                    position: raijin_lsp::Position::new(0, 1),
                                    label: raijin_lsp::InlayHintLabel::String("type hint".to_string()),
                                    kind: Some(raijin_lsp::InlayHintKind::TYPE),
                                    text_edits: None,
                                    tooltip: None,
                                    padding_left: None,
                                ...
                                raijin_lsp::InlayHint {
                                    position: raijin_lsp::Position::new(0, 2),
                                    label: raijin_lsp::InlayHintLabel::String(
                                        "parameter hint".to_string(),
                                    ),
                                    kind: Some(raijin_lsp::InlayHintKind::PARAMETER),
                                    text_edits: None,
                                    tooltip: None,
                                    padding_left: None,
                                    padding_right: None,
                                ...
                                raijin_lsp::InlayHint {
                                    position: raijin_lsp::Position::new(0, 3),
                                    label: raijin_lsp::InlayHintLabel::String("other hint".to_string()),
                                    kind: None,
                                    text_edits: None,
                                    tooltip: None,
                                    padding_left: None,
                        ...
                        fake_server.set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(
                            move |params, _| {
                                ...
                                async move {
                                    assert_eq!(
                                        params.text_document.uri,
                                        raijin_lsp::Uri::from_file_path(path!("/a/main.rs")).unwrap(),
                                    );
    ...
    async fn test_multiple_excerpts_large_multibuffer(cx: &mut inazuma::TestAppContext) {
        ...
        fake_server
            .set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(move |params, _| {
                ...
                async move {
                        ...
                        == raijin_lsp::Uri::from_file_path(path!("/a/main.rs")).unwrap()
                    {
                        ...
                        == raijin_lsp::Uri::from_file_path(path!("/a/other.rs")).unwrap()
                    {
                        "other hint"
                    } else {
                    ...
                    let positions = [
                        raijin_lsp::Position::new(0, 2),
                        raijin_lsp::Position::new(4, 2),
                        raijin_lsp::Position::new(22, 2),
                        raijin_lsp::Position::new(44, 2),
                        raijin_lsp::Position::new(56, 2),
                        raijin_lsp::Position::new(67, 2),
                    ];
                    let out_of_range_hint = raijin_lsp::InlayHint {
                        position: raijin_lsp::Position::new(
                    ...
                    Ok(Some(
                        std::iter::once(out_of_range_hint)
                            .chain(positions.into_iter().enumerate().map(|(i, position)| {
                                raijin_lsp::InlayHint {
                                    position,
                                    label: raijin_lsp::InlayHintLabel::String(format!(
                                        "{hint_text}{E} #{i}",
...
let c = 3;"#
                        ...
                        move |params, _| {
                            ...
                            async move {
                                    ...
                                    == raijin_lsp::Uri::from_file_path(path!("/a/main.rs")).unwrap()
                                {
                                    ...
                                    == raijin_lsp::Uri::from_file_path(path!("/a/lib.rs")).unwrap()
                                {
                                ...
                                Ok(Some(
                                    (params.range.start.line..params.range.end.line)
                                        .map(|row| raijin_lsp::InlayHint {
                                            position: raijin_lsp::Position::new(row, 0),
                                            label: raijin_lsp::InlayHintLabel::String(format!(
        ...
        assert_eq!(
            vec![
                (
                    "lib.rs",
                    raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(2, 10))
                ),
                (
                    "main.rs",
                    raijin_lsp::Range::new(raijin_lsp::Position::new(0, 0), raijin_lsp::Position::new(50, 0))
                ),
                (
                    "main.rs",
                    raijin_lsp::Range::new(raijin_lsp::Position::new(50, 0), raijin_lsp::Position::new(100, 0))
                ),
            ],
            lsp_request_ranges
                .lock()
                        ...
                        move |params, _| {
                            ...
                            async move {
                                    ...
                                    == raijin_lsp::Uri::from_file_path(path!("/a/main.rs")).unwrap()
                                {
                                    Ok(Some(vec![
                                        raijin_lsp::InlayHint {
                                            position: raijin_lsp::Position::new(1, 9),
                                        ...
                                        raijin_lsp::InlayHint {
                                            position: raijin_lsp::Position::new(19, 9),
                                            label: raijin_lsp::InlayHintLabel::String(": i33".to_owned()),
                                            kind: Some(raijin_lsp::InlayHintKind::TYPE),
                                            text_edits: None,
                                            tooltip: None,
                                            padding_left: None,
                                    ...
                                    == raijin_lsp::Uri::from_file_path(path!("/a/lib.rs")).unwrap()
                                {
                                    Ok(Some(vec![
                                        raijin_lsp::InlayHint {
                                            position: raijin_lsp::Position::new(1, 10),
                                            label: raijin_lsp::InlayHintLabel::String(": i34".to_owned()),
                                            kind: Some(raijin_lsp::InlayHintKind::TYPE),
                                            text_edits: None,
                                            tooltip: None,
                                            padding_left: None,
                                        ...
                                        raijin_lsp::InlayHint {
                                            position: raijin_lsp::Position::new(29, 10),
                                            label: raijin_lsp::InlayHintLabel::String(": i35".to_owned()),
                                            kind: Some(raijin_lsp::InlayHintKind::TYPE),
                                            text_edits: None,
                                            tooltip: None,
                                            padding_left: None,
                        ...
                        fake_server.set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(
                            move |params, _| {
                                ...
                                async move {
                                    ...
                                    Ok(Some(vec![raijin_lsp::InlayHint {
                                        position: raijin_lsp::Position::new(start_line + 1, 9),
                                        label: raijin_lsp::InlayHintLabel::String(format!(
                                            "chunk_{start_line}"
                                        )),
                                        kind: Some(raijin_lsp::InlayHintKind::TYPE),
                    ...
                    move |fake_server| {
                        ...
                        fake_server.set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(
                            move |_params, _| {
                                ...
                                async move {
                                    Ok(Some(vec![raijin_lsp::InlayHint {
                                        position: raijin_lsp::Position::new(0, 9),
                                        label: raijin_lsp::InlayHintLabel::String(format!(
                                            "server_a_{count}"
                                        )),
                                        kind: Some(raijin_lsp::InlayHintKind::TYPE),
                    ...
                    move |fake_server| {
                        ...
                        fake_server.set_request_handler::<raijin_lsp::request::InlayHintRequest, _, _>(
                            move |_params, _| {
                                ...
                                async move {
                                    Ok(Some(vec![raijin_lsp::InlayHint {
                                        position: raijin_lsp::Position::new(0, 22),
                                        label: raijin_lsp::InlayHintLabel::String(format!(
                                            "server_b_{count}"
                                        )),
                                        kind: Some(raijin_lsp::InlayHintKind::TYPE),
