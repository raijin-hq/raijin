            ...
            project
                .update(cx, |project, cx| {
                    project.request_lsp(
                        ...
                        raijin_project::lsp_store::lsp_ext_command::SwitchSourceHeader,
                        cx,
                    )
                })
                .await
