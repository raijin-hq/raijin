...
pub enum MenuPosition {
    ...
    PinnedToEditor {
        source: raijin_multi_buffer::Anchor,
        offset: Point<Pixels>,
    },
}
...
pub struct MouseContextMenu {
    ...
    pub(crate) context_menu: Entity<raijin_ui::ContextMenu>,
...
impl MouseContextMenu {
    pub(crate) fn pinned_to_editor(
        ...
        context_menu: Entity<raijin_ui::ContextMenu>,
        window: &mut Window,
...
pub fn deploy_context_menu(
    ...
    let context_menu = if let Some(custom) = editor.custom_context_menu.take() {
        ...
        raijin_ui::ContextMenu::build(window, cx, |menu, _window, _cx| {
            let builder = menu
                ...
                .action_disabled_when(
                    !has_git_repo,
                    "View File History",
                    Box::new(raijin_git::FileHistory),
                );
            match focus {
...
mod tests {
    use super::*;
    use crate::{editor_tests::init_test, test::editor_lsp_test_coninazuma_text::EditorLspTestContext};
    use indoc::indoc;
