...
impl WrapSnapshot {
    ...
    #[raijin_tracing::instrument(skip_all, fields(rows))]
    ...
    #[raijin_tracing::instrument(skip_all, fields(point=?point))]
    ...
    fn check_invariants(&self) {
        #[cfg(test)]
        {
            ...
            let text = raijin_language::Rope::from(self.text().as_str());
...
mod tests {
    ...
    async fn test_prev_row_boundary(cx: &mut inazuma::TestAppContext) {
        ...
        fn test_wrap_snapshot(
            ...
            let buffer = cx.new(|cx| raijin_language::Buffer::local(text, cx));
