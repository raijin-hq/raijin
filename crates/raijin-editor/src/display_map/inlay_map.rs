...
use raijin_language::{Chunk, Edit, Point, TextSummary};
...
use raijin_ui::{ActiveTheme, IntoElement as _, ParentElement as _, Styled as _, div};
...
impl InlaySnapshot {
    ...
    #[raijin_tracing::instrument(skip_all, fields(point))]
...
mod tests {
    ...
    use raijin_project::{InlayHint, InlayHintLabel, ResolveState};
    use rand::prelude::*;
    ...
    fn test_inlay_utf8_boundary_panic_fix(cx: &mut App) {
        ...
        //
        // See https://github.com/raijin-industries/raijin/issues/33641
