...
use raijin_language::CursorShape;
                            ...
                            editor.highlight_text(
                                ...
                                HighlightStyle {
                                    background_color: Some(
                                        cx.theme()
                                            .colors()
                                            .editor.document_highlight_bracket_background,
                                    ),
                                    ..Default::default()
                                },
                                cx,
...
mod tests {
    ...
    use indoc::indoc;
    use raijin_language::{BracketPair, BracketPairConfig, Language, LanguageConfig, LanguageMatcher};
