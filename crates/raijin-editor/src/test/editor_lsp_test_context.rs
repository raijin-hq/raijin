...
use anyhow::Result;
use raijin_language::{markdown_lang, rust_lang};
...
pub struct EditorLspTestContext {
    ...
    pub lsp: raijin_lsp::FakeLanguageServer,
    pub workspace: Entity<Workspace>,
    pub buffer_lsp_url: raijin_lsp::Uri,
}
...
impl EditorLspTestContext {
    pub async fn new(
        ...
        Self {
            ...
            lsp,
            workspace,
            buffer_lsp_url: raijin_lsp::Uri::from_file_path(root.join("dir").join(file_name)).unwrap(),
        }
    }
    ...
    pub async fn new_typescript(
        ...
        let language = Language::new(
            LanguageConfig {
                ...
                brackets: raijin_language::BracketPairConfig {
                    pairs: vec![raijin_language::BracketPair {
                        start: "{".to_string(),
                        end: "}".to_string(),
                        close: true,
                        surround: true,
    ...
    #[track_caller]
    pub fn lsp_range(&mut self, marked_text: &str) -> raijin_lsp::Range {
    ...
    pub fn to_lsp_range(&mut self, range: Range<MultiBufferOffset>) -> raijin_lsp::Range {
        use raijin_language::ToPointUtf16;
    ...
    #[expect(clippy::wrong_self_convention, reason = "This is test code")]
    pub fn to_lsp(&mut self, offset: MultiBufferOffset) -> raijin_lsp::Position {
        use raijin_language::ToPointUtf16;
    ...
    where
        ...
        F: 'static + Send + FnMut(raijin_lsp::Uri, T::Params, inazuma::AsyncApp) -> Fut,
