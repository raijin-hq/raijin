...
impl Editor {
    ...
    pub fn document_folding_ranges_enabled(&self, cx: &raijin_ui::App) -> bool {
...
mod tests {
    ...
    async fn test_lsp_folding_ranges_populates_creases(cx: &mut TestAppContext) {
        ...
        let mut folding_request = cx
            .set_request_handler::<raijin_lsp::request::FoldingRangeRequest, _, _>(
