...
use raijin_language::Language;
use raijin_lsp::LanguageServerId;
use raijin_lsp::LanguageServerName;
use raijin_multi_buffer::Anchor;
use raijin_project::LanguageServerToQuery;
use raijin_project::LocationLink;
use raijin_project::Project;
use raijin_project::TaskSourceKind;
use raijin_project::lsp_store::lsp_ext_command::GetLspRunnables;
...
pub fn lsp_tasks(
    ...
    cx.spawn(async move |cx| {
        ...
        .race({
            // `raijin_lsp::DEFAULT_LSP_REQUEST_TIMEOUT` is larger than we want for the modal to open fast
