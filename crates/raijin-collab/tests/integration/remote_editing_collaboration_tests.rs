...
use raijin_dap::{Capabilities, adapters::DebugTaskDefinition, transport::RequestHandling};
use raijin_debugger_ui::debugger_panel::DebugPanel;
use raijin_editor::{Editor, EditorMode, MultiBuffer};
...
async fn test_remote_server_debugger(
    ...
    let workspace_window = cx_a
        .window_handle()
        .downcast::<raijin_workspace::Workspace>()
        .unwrap();
