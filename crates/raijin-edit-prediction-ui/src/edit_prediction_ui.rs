...
use raijin_edit_prediction::{EditPredictionStore, ResetOnboarding, capture_example};
...
use raijin_ui::{App, prelude::*};
use raijin_workspace::{SplitDirection, Workspace};
...
fn feature_gate_predict_edits_actions(cx: &mut App) {
    ...
    let all_action_types = [
        ...
        TypeId::of::<raijin_edit_prediction::ResetOnboarding>(),
        raijin_actions::OpenRaijinPredictOnboarding.type_id(),
        TypeId::of::<raijin_edit_prediction::ClearHistory>(),
    ...
    CommandPaletteFilter::update_global(cx, |filter, _cx| {
        ...
        filter.hide_action_types(&[raijin_actions::OpenRaijinPredictOnboarding.type_id()]);
    });
