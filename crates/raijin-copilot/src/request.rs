...
impl raijin_lsp::request::Request for CheckStatus {
...
pub struct PromptUserDeviceFlow {
    ...
    pub command: raijin_lsp::Command,
}

impl raijin_lsp::request::Request for SignIn {
...
impl raijin_lsp::request::Request for SignOut {
...
impl raijin_lsp::notification::Notification for DidChangeStatus {
...
impl raijin_lsp::request::Request for SetEditorInfo {
...
impl raijin_lsp::request::Request for NotifyAccepted {
...
impl raijin_lsp::request::Request for NotifyRejected {
...
pub struct NextEditSuggestionsParams {
    ...
    pub(crate) position: raijin_lsp::Position,
}
...
pub struct NextEditSuggestion {
    ...
    pub range: raijin_lsp::Range,
    pub command: Option<raijin_lsp::Command>,
}
...
impl raijin_lsp::request::Request for NextEditSuggestions {
...
impl raijin_lsp::notification::Notification for DidFocus {
...
impl raijin_lsp::notification::Notification for DidShowInlineEdit {
...
impl raijin_lsp::request::Request for InlineCompletions {
...
impl raijin_lsp::notification::Notification for DidShowCompletion {
