...
impl TcpArgumentsTemplate {
    ...
    pub fn from_proto(proto: raijin_proto::TcpHost) -> Result<Self> {
        Ok(Self {
...
impl DebugRequest {
    pub fn to_proto(&self) -> raijin_proto::DebugRequest {
        match self {
            DebugRequest::Launch(launch_request) => raijin_proto::DebugRequest {
                request: Some(raijin_proto::debug_request::Request::DebugLaunchRequest(
                    raijin_proto::DebugLaunchRequest {
            ...
            DebugRequest::Attach(attach_request) => raijin_proto::DebugRequest {
                request: Some(raijin_proto::debug_request::Request::DebugAttachRequest(
                    raijin_proto::DebugAttachRequest {
    ...
    pub fn from_proto(val: raijin_proto::DebugRequest) -> Result<DebugRequest> {
        let request = val.request.context("Missing debug request")?;
        match request {
            raijin_proto::debug_request::Request::DebugLaunchRequest(raijin_proto::DebugLaunchRequest {
                program,
                cwd,
                args,
                env,
            ...
            raijin_proto::debug_request::Request::DebugAttachRequest(raijin_proto::DebugAttachRequest {
                process_id,
